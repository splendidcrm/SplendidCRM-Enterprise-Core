...
export default class AtlanticHeaderButtons extends HeaderButtons
{
	...
	public render()
	{
		...
		// 11/05/2020 Paul.  Inbound Emails alters the module title. 
		if ( !Sql.IsEmptyString(SUB_TITLE) && !Sql.IsEmptyString(MODULE_TITLE) )
		{
			sMODULE_TITLE = L10n.Term(MODULE_TITLE);
		}
		let sSUB_TITLE   : string = !Sql.IsEmptyString(SUB_TITLE) ? SUB_TITLE : (!Sql.IsEmptyString(MODULE_TITLE) ? L10n.Term(MODULE_TITLE) : null);
