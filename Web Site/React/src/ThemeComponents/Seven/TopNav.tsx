...
// 04/25/2021 Paul.  Arctic and Seven are nearly identical TopNav classes. 
@observer
class SevenTopNav extends React.Component<ITopNavProps, ITopNavState>
{
...
<div id='divHeader' style={ {marginTop: '45px'} }>
	...
	<React.Fragment key={ "actionsModule_" + menuChangeKey.toString() }>
		...
		else
		{
			...
			let logoUrl   : string = Sql.IsEmptyString(Crm_Config.ToString('header_logo_image' )) ? '~/App_Themes/Seven/images/SplendidCRM_Logo.png' : Crm_Config.ToString('header_logo_image' );
...
export default withRouter(SevenTopNav);
