...
const MODULE_NAME: string = 'Charts';
...
@observer
export default class ChartsImportView extends React.Component<IEditViewProps, IEditViewState>
{
				...
				case 'Import':
				{
					...
					if ( nInvalidFields == 0 )
					{
						try
						{
							...
							let sUrl : string = 'Charts/Rest.svc/Import';
							let res = await CreateSplendidRequest(sUrl + '?ModuleName=' + MODULE_NAME, 'POST', 'application/octet-stream', sBody);
