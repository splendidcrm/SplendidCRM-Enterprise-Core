...
@observer
class SystemSyncLogListView extends React.Component<IAdminReadOnlyListViewProps, IAdminReadOnlyListViewState>
{
	...
	public render()
	{
		...
		if ( SplendidCache.IsInitialized && SplendidCache.AdminMenu )
		{
			...
			let MODULE_TITLE  : string = 'Administration.LBL_SYSTEM_SYNC_LOG';
...
export default withRouter(SystemSyncLogListView);
