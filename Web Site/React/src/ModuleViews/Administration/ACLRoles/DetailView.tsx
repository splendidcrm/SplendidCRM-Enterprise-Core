...
@observer
class ACLRolesDetailView extends React.Component<IDetailViewProps, IAdminDetailViewState>
{
	...
	private Page_Command = async (sCommandName, sCommandArguments) =>
	{
		...
		switch ( sCommandName )
		{
			...
			case 'FieldSecurity':
			{
				history.push(`/Reset/Administration/ACLRoles/Edit/${ID}/FieldSecurity`);
				break;
			}
			case 'Export':
			{
				window.location.href = Credentials.RemoteServer + 'Administration/ACLRoles/export.aspx?ID=' + ID;
				break;
			}
			default:
			{
...
export default withRouter(ACLRolesDetailView);
