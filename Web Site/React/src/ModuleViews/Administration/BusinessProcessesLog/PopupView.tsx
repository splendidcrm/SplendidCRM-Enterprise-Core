...
const MODULE_NAME: string = 'BusinessProcessesLog';
...
export default class BusinessProcessesPopupView extends React.Component<IActivitiesPopupViewProps, IActivitiesPopupViewState>
{
	...
	private Load = async (sMODULE_NAME, sSORT_FIELD, sSORT_DIRECTION, sSELECT, sFILTER, rowSEARCH_VALUES, nTOP, nSKIP, bADMIN_MODE?, archiveView?) =>
	{
		...
		sFILTER = "INSTANCE_ID eq '" + INSTANCE_ID  + "'";
		let d = await ListView_LoadTablePaginated('vwWF4_INSTANCE_EVENTS', sSORT_FIELD, sSORT_DIRECTION, sSELECT, sFILTER, rowSEARCH_VALUES, nTOP, nSKIP, bADMIN_MODE, archiveView);
		return d;
	}
	...
	public renderBody = () =>
	{
		...
		return (<React.Fragment>
					<ListHeader TITLE='BusinessProcessesLog.LBL_LIST_FORM_TITLE' />
