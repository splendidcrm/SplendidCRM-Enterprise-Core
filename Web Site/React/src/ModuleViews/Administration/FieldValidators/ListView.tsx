...
@observer
class FieldValidatorsListView extends React.Component<IAdminListViewProps, IAdminListViewState>
{
	...
	{
		window.location.href = Credentials.RemoteServer + 'Administration/FieldValidators/export.aspx?ID=';
	}
...
export default withRouter(FieldValidatorsListView);
