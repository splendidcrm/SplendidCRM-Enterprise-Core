...
@observer
class AzureSystemLogListView extends React.Component<IAdminReadOnlyListViewProps, IAdminReadOnlyListViewState>
{
...
export default withRouter(AzureSystemLogListView);
