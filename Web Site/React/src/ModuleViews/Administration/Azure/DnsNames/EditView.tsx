...
@observer
export default class DnsNamesEditView extends React.Component<IAdminEditViewProps, IAdminEditViewState>
{
				...
				case 'SaveConcurrency':
				{
					...
					if ( nInvalidFields == 0 )
					{
						...
						try
						{
							...
							let res = await CreateSplendidRequest('Administration/Azure/Rest.svc/CreateDnsName', 'POST', 'application/json; charset=utf-8', sBody);
