...
@observer
class AzureDnsNames extends React.Component<ISubPanelViewProps, ISubPanelViewState>
{
	...
	private Load = async (sMODULE_NAME, sSORT_FIELD, sSORT_DIRECTION, sSELECT, sFILTER, rowSEARCH_VALUES, nTOP, nSKIP, bADMIN_MODE?, archiveView?) =>
	{
		...
		let res = await CreateSplendidRequest('Administration/Azure/Rest.svc/GetDnsNames' + params, 'GET');
...
export default withRouter(AzureDnsNames);
