...
@observer
export default class StorageAccountsEditView extends React.Component<IAdminEditViewProps, IAdminEditViewState>
{
				...
				case 'SaveConcurrency':
				{
					...
					if ( nInvalidFields == 0 )
					{
						...
						try
						{
							...
							let res = await CreateSplendidRequest('Administration/Azure/Rest.svc/CreateStorageAccount', 'POST', 'application/json; charset=utf-8', sBody);
							let json = await GetSplendidResult(res);
							row.ID = json.d;
