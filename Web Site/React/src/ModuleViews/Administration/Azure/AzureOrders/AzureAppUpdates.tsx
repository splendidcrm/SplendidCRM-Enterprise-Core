...
@observer
class AzureOrdersAppUpdates extends React.Component<ISubPanelViewProps, ISubPanelViewState>
{
	...
	private onCancelOrder = async (row) =>
	{
		...
		try
		{
			let data: any =
			{
				AZURE_ORDER_ID: PARENT_ID,
				APP_UPDATE_ID : row['ID'],
...
export default withRouter(AzureOrdersAppUpdates);
