...
@observer
class CloudServicesListView extends React.Component<IAdminListViewProps, IAdminListViewState>
{
	...
	private _onHyperLinkCallback = (MODULE_NAME: string, ID: string, NAME: string, URL: string, row?: any) =>
	{
		...
		else
		{
			...
			history.push(`/Reset${admin}/Azure/${MODULE_NAME}/View/${ID}`);
		}
	}
	...
	private Page_Command = async (sCommandName, sCommandArguments) =>
	{
		...
		switch ( sCommandName )
		{
			case 'Create':
			{
				...
				history.push(`/Reset${admin}/Azure/${MODULE_NAME}/Edit`);
				break;
			}
			// 04/09/2022 Paul.  Hide/show SearchView. 
...
export default withRouter(CloudServicesListView);
