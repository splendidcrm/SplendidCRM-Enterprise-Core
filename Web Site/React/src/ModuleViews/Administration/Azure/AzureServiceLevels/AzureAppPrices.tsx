...
@observer
class AzureServiceLevelsAzureAppPrices extends React.Component<ISubPanelViewProps, ISubPanelViewState>
{
...
export default withRouter(AzureServiceLevelsAzureAppPrices);
