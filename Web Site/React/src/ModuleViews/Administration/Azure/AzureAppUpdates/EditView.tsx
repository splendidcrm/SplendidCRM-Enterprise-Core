...
@observer
export default class AzureAppUpdatesEditView extends React.Component<IAdminEditViewProps, IAdminEditViewState>
{
			...
			if ( this._isMounted )
			{
				...
				if ( json.d != null && json.d.results != null )
				{
					...
					for ( let i: number = 0; i < json.d.results.length; i++ )
					{
						...
						SplendidCache.SetListTerm('AzureStorageAccounts', row['Name'], row['Name'] );
					}
					SplendidCache.SetTerminologyList('AzureStorageAccounts', arrListValues);
				}
