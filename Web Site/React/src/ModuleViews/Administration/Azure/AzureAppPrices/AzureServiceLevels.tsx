...
@observer
class AzureAppPricesAzureServiceLevels extends React.Component<ISubPanelViewProps, ISubPanelViewState>
{
...
export default withRouter(AzureAppPricesAzureServiceLevels);
