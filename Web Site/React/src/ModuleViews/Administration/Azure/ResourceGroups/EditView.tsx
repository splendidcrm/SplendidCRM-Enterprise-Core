...
@observer
export default class ResourceGroupsEditView extends React.Component<IAdminEditViewProps, IAdminEditViewState>
{
	...
	private load = async () =>
	{
		...
		try
		{
			...
			if ( this._isMounted )
			{
				...
				let obj = new Object();
				obj['TableName'    ] = Crm_Modules.TableName('AzureRegions');
