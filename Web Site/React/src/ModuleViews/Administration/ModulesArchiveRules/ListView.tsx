...
@observer
class ModulesArchiveRulesAdminListView extends React.Component<IAdminListViewProps, IAdminListViewState>
{
...
export default withRouter(ModulesArchiveRulesAdminListView);
