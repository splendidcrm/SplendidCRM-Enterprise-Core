...
@observer
class WorkflowAlertTemplatesDetailView extends React.Component<IDetailViewProps, IAdminDetailViewState>
{
...
export default withRouter(WorkflowAlertTemplatesDetailView);
