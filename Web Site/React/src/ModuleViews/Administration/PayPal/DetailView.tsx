...
@observer
class PayPalDetailView extends React.Component<IDetailViewProps, IAdminDetailViewState>
{
	...
	private LoadItem = async (sMODULE_NAME: string, sID: string) =>
	{
		try
		{
			...
			let res = await CreateSplendidRequest('Administration/PayPalTransactions/Rest.svc/GetTransaction?ID=' + sID, 'GET');
...
export default withRouter(PayPalDetailView);
