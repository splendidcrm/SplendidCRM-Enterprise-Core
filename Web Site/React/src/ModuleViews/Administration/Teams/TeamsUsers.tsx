...
@observer
class TeamsUsers extends React.Component<ISubPanelViewProps, ISubPanelViewState>
{
	...
	private _onShowRemove = (row): boolean =>
	{
		// 10/15/2020 Paul.  Implicitly assigned teams cannot be removed, so hide the icon. 
		return Sql.ToBoolean(row['EXPLICIT_ASSIGN']);
	}
...
export default withRouter(TeamsUsers);
