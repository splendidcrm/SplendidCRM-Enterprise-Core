...
@observer
class AsteriskListView extends React.Component<IAdminListViewProps, IAdminListViewState>
{
		...
		if ( SplendidCache.IsInitialized && SplendidCache.AdminMenu )
		{
			...
			<div>
				...
				<SplendidGrid
					...
					GRID_NAME={ GRID_NAME }
					TABLE_NAME='vwCALL_DETAIL_RECORDS'
...
export default withRouter(AsteriskListView);
