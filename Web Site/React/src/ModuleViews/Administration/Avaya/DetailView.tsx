...
const MODULE_NAME: string = 'Avaya';
...
@observer
class AvayaDetailView extends React.Component<IDetailViewProps, IAdminDetailViewState>
{
...
export default withRouter(AvayaDetailView);
