...
@observer
class EmailManListView extends React.Component<IAdminListViewProps, IAdminListViewState>
{
	...
	private Page_Command = async (sCommandName, sCommandArguments) =>
	{
		...
		switch ( sCommandName )
		{
			...
			case 'SendQueued':
			{
				...
				{
					this.setState({ error: '' });
					let res  = await CreateSplendidRequest('Administration/EmailMan/Rest.svc/SendQueued', 'POST', 'application/octet-stream', null);
...
export default withRouter(EmailManListView);
