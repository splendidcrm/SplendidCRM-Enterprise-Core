...
@observer
class BusinessRulesAdminListView extends React.Component<IAdminListViewProps, IAdminListViewState>
{
	...
	private Load = async (sMODULE_NAME, sSORT_FIELD, sSORT_DIRECTION, sSELECT, sFILTER, rowSEARCH_VALUES, nTOP, nSKIP, bADMIN_MODE?, archiveView?) =>
	{
		...
		let d = await ListView_LoadTablePaginated('vwBUSINESS_RULES', sSORT_FIELD, sSORT_DIRECTION, sSELECT, sFILTER, rowSEARCH_VALUES, nTOP, nSKIP, bADMIN_MODE, archiveView);
		return d;
	}
...
export default withRouter(BusinessRulesAdminListView);
