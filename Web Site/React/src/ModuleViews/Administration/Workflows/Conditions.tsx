...
@observer
class WorkflowsConditions extends React.Component<ISubPanelViewProps, ISubPanelViewState>
{
	...
	constructor(props: ISubPanelViewProps)
	{
		...
		let GRID_NAME  : string = props.PARENT_TYPE + '.WorkflowTriggerShells';
...
export default withRouter(WorkflowsConditions);
