...
@observer
class WorkflowsAlerts extends React.Component<ISubPanelViewProps, ISubPanelViewState>
{
	...
	constructor(props: ISubPanelViewProps)
	{
		...
		let GRID_NAME  : string = props.PARENT_TYPE + '.WorkflowAlertShells';
...
export default withRouter(WorkflowsAlerts);
