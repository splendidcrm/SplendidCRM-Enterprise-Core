...
class EmployeesListView extends React.Component<IListViewProps, IListViewState>
{
			...
			<div style={ {display: 'flex', flexDirection: 'row', flexWrap: 'nowrap', width: '100%'} }>
				<div id='divListView' style={ {width: '100%'} }>
					...
					<SplendidGrid
						...
						disableEdit={ SplendidCache.AdminUserAccess(MODULE_NAME, 'edit') < 0 }
...
export default withRouter(EmployeesListView);
