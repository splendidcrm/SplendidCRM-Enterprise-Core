...
@observer
export default class DocumentsEditView extends React.Component<IEditViewProps, IEditViewState>
{
				...
				case 'SaveConcurrency':
				{
					...
					if ( nInvalidFields == 0 )
					{
						...
						try
						{
							...
							{
								let sPRIMARY_MODULE = 'Documents'     ;
								let sPRIMARY_ID     = row.ID          ;
								let sRELATED_MODULE = this.PARENT_TYPE;
								let sRELATED_ID     = this.PARENT_ID  ;
