...
@observer
export default class ChatMessagesEditView extends React.Component<IEditViewProps, IEditViewState>
{
	...
	private CHAT_CHANNEL_ID  : string = null;
	private CHAT_CHANNEL_NAME: string = null;
	...
	private load = async () =>
	{
		...
		try
		{
			...
			*/
			if ( !Sql.IsEmptyGuid(queryParams['CHAT_CHANNEL_ID']) )
			{
				this.CHAT_CHANNEL_ID   = queryParams['CHAT_CHANNEL_ID'];
				this.CHAT_CHANNEL_NAME = await Crm_Modules.ItemName('ChatChannels', this.CHAT_CHANNEL_ID);
				rowDefaultSearch = 
				{
					CHAT_CHANNEL_ID  : this.CHAT_CHANNEL_ID  ,
					CHAT_CHANNEL_NAME: this.CHAT_CHANNEL_NAME,
				};
			}
