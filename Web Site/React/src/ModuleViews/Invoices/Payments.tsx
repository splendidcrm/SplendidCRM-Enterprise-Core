...
@observer
class InvoicesPayments extends React.Component<ISubPanelViewProps, ISubPanelViewState>
{
		...
		try
		{
			if ( this._isMounted )
			{
				if ( sCommandName == 'Create' || EndsWith(sCommandName, '.Create') )
				{
					...
					// 05/06/2022 Paul.  Inline editing is not enabled. 
...
export default withRouter(InvoicesPayments);
