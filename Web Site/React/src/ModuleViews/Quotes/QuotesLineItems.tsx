...
const MODULE_NAME: string = 'Quotes';

interface IQuotesLineItemsState extends IOrdersLineItemsEditorState
{
	layout         : EDITVIEWS_FIELD[];
}

export default class QuotesLineItems extends OrdersLineItemsEditor<IOrdersLineItemsEditorProps, IQuotesLineItemsState>
{
	public get data (): any
	{
		let obj: any = null;
