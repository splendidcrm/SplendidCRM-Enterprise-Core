...
@observer
export default class ReportRulesEditView extends React.Component<IEditViewProps, IEditViewState>
{
	...
	public render()
	{
		...
		const { item, editedItem, layout, EDIT_NAME, SUB_TITLE, error } = this.state;
		...
		if ( SplendidCache.IsInitialized )
		{
			...
			<React.Fragment>
				...
				<RuleBuilder RULE_TYPE='Report' row={ currentItem } onChanged={ this._onChange } ref={ this.ruleBuilder } />
				{ !callback && headerButtons
				? <DynamicButtons
