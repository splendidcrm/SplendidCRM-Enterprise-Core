...
interface IOrdersLineItemsState extends IOrdersLineItemsEditorState
{
	layout         : EDITVIEWS_FIELD[];
}

export default class OrdersLineItems extends OrdersLineItemsEditor<IOrdersLineItemsEditorProps, IOrdersLineItemsState>
{
	public get data (): any
	{
		let obj: any = null;
