...
@observer
export default class BugsEditView extends React.Component<IEditViewProps, IEditViewState>
{
		...
		try
		{
			...
			switch (sCommandName)
			{
				...
				case 'SaveConcurrency':
				{
					...
					if ( nInvalidFields == 0 )
					{
						// 04/20/2020 Paul.  Stored procedures uses name without ID. 
						row['FOUND_IN_RELEASE'] = row['FOUND_IN_RELEASE_ID'];
						row['FIXED_IN_RELEASE'] = row['FIXED_IN_RELEASE_ID'];
