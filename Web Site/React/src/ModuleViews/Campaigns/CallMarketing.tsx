...
@observer
class CampaignsCallMarketing extends React.Component<ISubPanelViewProps, ISubPanelViewState>
{
	...
	public render()
	{
		...
		if ( SplendidCache.IsInitialized  )
		{
			...
			// 08/11/2021 Paul.  Allow custom popups from custom layouts. 
			// 09/26/2021 Paul.  CallMarketing and EmailMarketing will hide/show based on Campaign Type. 
			if ( row['CAMPAIGN_TYPE'] == 'Telesales' )
			{
				return (
					<React.Fragment>
						<DynamicPopupView
...
export default withRouter(CampaignsCallMarketing);
