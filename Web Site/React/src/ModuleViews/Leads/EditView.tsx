...
@observer
export default class LeadsEditView extends React.Component<IEditViewProps, IEditViewState>
{
	...
	// 05/14/2018 Chase. This function will be passed to headerButtons to be called as Page_Command
	...
	private Page_Command = async (sCommandName, sCommandArguments) =>
	{
		...
		// This sets the local state, which is then passed to headerButtons
		try
		{
			let row;
			switch (sCommandName)
