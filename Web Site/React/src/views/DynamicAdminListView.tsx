...
interface IDynamicAdminListViewProps extends RouteComponentProps<any>
{
	MODULE_NAME: string;
...
interface IDynamicAdminListViewState
{
	customView?: any;
	error?     : any;
}
...
@observer
class DynamicAdminListView extends React.Component<IDynamicAdminListViewProps, IDynamicAdminListViewState>
{
	private _isMounted = false;

	constructor(props: IDynamicAdminListViewProps)
	{
		super(props);
	...
	componentDidUpdate(prevProps: IDynamicAdminListViewProps)
	{
	...
	public render()
	{
		...
		{
			// 06/26/2019 Paul.  Specify a key so that SplendidGrid will get componentDidMount when changing views. 
			return <AdminListView key={ this.props.MODULE_NAME } {...this.props} />;
		}
		else
		{
			return null;
...
export default withRouter(DynamicAdminListView);
