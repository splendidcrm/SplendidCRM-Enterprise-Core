...
const DraggableRow: FC<IDraggableRowProps> = memo(function DraggableRow(props: IDraggableRowProps)
{
	...
	const { id, index, length, children, moveDraggableRow, moveDraggableItem, addSourceItem, removeRow } = props;
	...
	(
		...
		[id, index, length, moveDraggableRow, moveDraggableItem, addSourceItem],
	);
