...
interface IReportViewerFrameState
{
...
@observer
export default class ReportViewerFrame extends React.Component<IDashletProps, IReportViewerFrameState>
{
	...
	public render()
	{
		...
		let sLayoutPanel = 'ReportViewerFrame_' + ID;
