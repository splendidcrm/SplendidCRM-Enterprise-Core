...
interface IBaseMyDashletProps extends IDashletProps
{
	MODULE_NAME      : string;
	SORT_FIELD       : string;
...
export default class BaseMyDashlet extends React.Component<IBaseMyDashletProps, IBaseMyDashletState>
{
	...
	constructor(props: IBaseMyDashletProps)
	{
		super(props);
		// 10/28/2020 Paul.  A customer preferred the old icons instead of the new fontawesome icons. 
