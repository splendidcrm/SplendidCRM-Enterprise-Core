...
namespace Spring.Social.iContact
{
	public class UserSync
	{
		...
		private iContactSync         iContactSync       ;
		public Guid        USER_ID;
		public bool        SyncAll;

		public UserSync(HttpSessionState Session, Security Security, SplendidError SplendidError, ExchangeSecurity ExchangeSecurity, SyncError SyncError, iContactSync iContactSync, Guid gUSER_ID, bool bSyncAll)
		{
		...
		public void Start()
		{
			...
			iContactSync.Sync(this, sbErrors);
