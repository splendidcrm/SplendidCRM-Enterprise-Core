...
{
	public class iContactJsonHttpMessageConverter : AbstractHttpMessageConverter
	{
		...
		public iContactJsonHttpMessageConverter(JsonMapper mapper) :
			base(new MediaType("text", "html"))
		{
			this.mapper = mapper;
		}
