...
// 04/07/2010 Paul.  We need to define a separate namespace for the Notification Service
// so that it does not collide with the Exchange Web Service classes. 
namespace ExchangeNotificationService
{
	// 
