...
{
	class RecurrenceRangeDeserializer : IJsonDeserializer
	{
		public object Deserialize(JsonValue json, JsonMapper mapper)
		{
			RecurrenceRange obj = new RecurrenceRange();
			obj.EndDate              = json.GetValueOrDefault<DateTime?> ("endDate"            );
			obj.NumberOfOccurrences  = json.GetValueOrDefault<Int32?   > ("numberOfOccurrences");
			obj.RecurrenceTimeZone   = json.GetValueOrDefault<String   > ("recurrenceTimeZone" );
