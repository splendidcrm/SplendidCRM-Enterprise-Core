...
{
	class ResponseStatusDeserializer : IJsonDeserializer
	{
		public object Deserialize(JsonValue json, JsonMapper mapper)
		{
			ResponseStatus obj = new ResponseStatus();
			obj.Response             = json.GetValueOrDefault<String>    ("response"      );
			obj.Time                 = json.GetValueOrDefault<DateTime?> ("time"          );
