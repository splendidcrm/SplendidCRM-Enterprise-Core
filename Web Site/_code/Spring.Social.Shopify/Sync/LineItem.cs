...
namespace Spring.Social.Shopify
{
	public class LineItem : QObject
	{
		...
		public string   ShopifyParentField ;
		...
		public LineItem(HttpSessionState Session, Security Security, Sql Sql, SqlProcs SqlProcs, ExchangeSecurity ExchangeSecurity, SyncError SyncError, Spring.Social.Shopify.Api.IShopify shopify, DataTable dtItems, Guid gSYNC_LOCAL_ID, string sSYNC_REMOTE_KEY, string sShopifyParentField, string sShopifyTableName, string sCRMModuleName, string sCRMTableName, string sCRMTableSort, string sCRMParentFieldName, bool bCRMAssignedUser)
			: base(Session, Security, Sql, SqlProcs, ExchangeSecurity, SyncError, shopify, sShopifyTableName, "ItemLineID", sCRMModuleName, sCRMTableName, sCRMTableSort, bCRMAssignedUser, false, false)
		{
			this.ShopifyParentField = sShopifyParentField;
		...
		public void SetFromShopify(DataRow row)
		{
