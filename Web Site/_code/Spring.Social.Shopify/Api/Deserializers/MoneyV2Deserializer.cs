...
{
	class MoneyV2Deserializer : IJsonDeserializer
	{
		public object Deserialize(JsonValue json, JsonMapper mapper)
		{
			MoneyV2 obj = new MoneyV2();
	...
	class MoneyV2ListDeserializer : IJsonDeserializer
	{
		public object Deserialize(JsonValue value, JsonMapper mapper)
		{
			IList<MoneyV2> txns = new List<MoneyV2>();
			if ( value != null && value.IsArray )
			{
				foreach ( JsonValue itemValue in value.GetValues() )
				{
					txns.Add( mapper.Deserialize<MoneyV2>(itemValue) );
				}
			}
			return txns;
		}
