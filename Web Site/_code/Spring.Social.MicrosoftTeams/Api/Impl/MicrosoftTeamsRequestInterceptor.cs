...
{
	public class MicrosoftTeamsRequestInterceptor : IClientHttpRequestBeforeInterceptor
	{
		private string name ;
		private string value;

		public MicrosoftTeamsRequestInterceptor(string name, string value)
		{
			this.name  = name ;
			this.value = value;
		}
		...
		{
			request.Headers[this.name] = this.value;
		}
