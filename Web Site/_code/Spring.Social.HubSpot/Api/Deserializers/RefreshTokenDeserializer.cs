...
{
	class RefreshTokenDeserializer : IJsonDeserializer
	{
		public object Deserialize(JsonValue json, JsonMapper mapper)
		{
			RefreshToken obj = new RefreshToken();
			obj.portal_id     = json.GetValueOrDefault<string>("portal_id"    );
			obj.expires_in    = json.GetValueOrDefault<int   >("expires_in"   );
