...
namespace Spring.Social.Watson
{
	public class UserSync
	{
		...
		private WatsonSync           WatsonSync           ;
		public Guid        USER_ID;
		public bool        SyncAll;

		public UserSync(HttpSessionState Session, Security Security, SplendidError SplendidError, ExchangeSecurity ExchangeSecurity, SyncError SyncError, WatsonSync WatsonSync, Guid gUSER_ID, bool bSyncAll)
		{
