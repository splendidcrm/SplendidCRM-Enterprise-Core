...
{
	class PrimaryAddressDeserializer : IJsonDeserializer
	{
		public object Deserialize(JsonValue json, JsonMapper mapper)
		{
			PrimaryAddress obj = new PrimaryAddress();

			try
			{
				obj.user_address_id = json.GetValueOrDefault<String>("user_address_id" );
				obj.address         = json.GetValueOrDefault<String>("address"         );
				obj.address_2       = json.GetValueOrDefault<String>("address_2"       );
