...
{
	class AdditionalNameSerializer : IJsonSerializer
	{
		public JsonValue Serialize(object obj, JsonMapper mapper)
		{
			AdditionalName o = obj as AdditionalName;
	...
	class AdditionalNameListSerializer : IJsonSerializer
	{
		public JsonValue Serialize(object obj, JsonMapper mapper)
		{
			IList<AdditionalName> lst = obj as IList<AdditionalName>;
			JsonArray json = new JsonArray();
			if ( lst != null )
			{
				foreach ( AdditionalName o in lst )
				{
