...
namespace Spring.Social.PhoneBurner
{
	public class UserSync
	{
		...
		private PhoneBurnerSync      PhoneBurnerSync    ;
		public Guid        USER_ID;
		public bool        SyncAll;

		public UserSync(HttpSessionState Session, Security Security, SplendidError SplendidError, ExchangeSecurity ExchangeSecurity, SyncError SyncError, PhoneBurnerSync PhoneBurnerSync, Guid gUSER_ID, bool bSyncAll)
		{
		...
		public void Start()
		{
			...
			PhoneBurnerSync.Sync(this, sbErrors);
