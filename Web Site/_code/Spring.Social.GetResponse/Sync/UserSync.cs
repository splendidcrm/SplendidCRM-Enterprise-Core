...
namespace Spring.Social.GetResponse
{
	public class UserSync
	{
		...
		private GetResponseSync      GetResponseSync    ;
		public Guid        USER_ID;
		public bool        SyncAll;

		public UserSync(HttpSessionState Session, Security Security, SplendidError SplendidError, ExchangeSecurity ExchangeSecurity, SyncError SyncError, GetResponseSync GetResponseSync, Guid gUSER_ID, bool bSyncAll)
		{
		...
		public void Start()
		{
			...
			GetResponseSync.Sync(this, sbErrors);
