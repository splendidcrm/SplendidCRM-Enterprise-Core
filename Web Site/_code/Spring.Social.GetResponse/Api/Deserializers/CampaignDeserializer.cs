...
namespace Spring.Social.GetResponse.Api.Impl.Json
{
	class CampaignDeserializer : IJsonDeserializer
	{
		public object Deserialize(JsonValue json, JsonMapper mapper)
		{
			...
			obj.id           = json.GetValueOrDefault<string   >("campaignId"    );
			...
			obj.languageCode = json.GetValueOrDefault<string   >("languageCode"  );
			obj.isDefault    = json.GetValueOrDefault<bool?    >("isDefault"     );
			return obj;
		}
	}
