...
{
	public abstract class GetResponseOAuth2ApiBinding : IApiBinding
	{
		...
		protected GetResponseOAuth2ApiBinding(string apiKey)
		{
			this.apiKey       = apiKey;
			this.restTemplate = new RestTemplate();
			((WebClientHttpRequestFactory)restTemplate.RequestFactory).Expect100Continue = false;
			this.RestTemplate.RequestInterceptors.Add(new GetResponseRequestInterceptor("X-Auth-Token", "api-key " + apiKey));
