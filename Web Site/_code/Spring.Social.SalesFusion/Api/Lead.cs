...
namespace Spring.Social.SalesFusion.Api
{
	...
	public class Lead : Contact
	{
		...
		public static DataTable ConvertToTable(IList<Lead> contacts)
		{
			DataTable dt = Lead.CreateTable();
			if ( contacts != null )
			{
				foreach ( Lead contact in contacts )
				{
					DataRow row = dt.NewRow();
					dt.Rows.Add(row);
					contact.SetRow(row);
	...
	public class LeadPagination : HPagination
	{
		public IList<Lead> results     { get; set; }
	}
}
