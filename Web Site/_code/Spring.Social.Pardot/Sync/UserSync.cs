...
namespace Spring.Social.Pardot
{
	public class UserSync
	{
		...
		private PardotSync           PardotSync         ;
		public Guid        USER_ID;
		public bool        SyncAll;

		public UserSync(HttpSessionState Session, Security Security, SplendidError SplendidError, ExchangeSecurity ExchangeSecurity, SyncError SyncError, PardotSync PardotSync, Guid gUSER_ID, bool bSyncAll)
		{
