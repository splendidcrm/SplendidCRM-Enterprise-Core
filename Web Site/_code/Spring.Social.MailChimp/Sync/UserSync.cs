...
namespace Spring.Social.MailChimp
{
	public class UserSync
	{
		...
		private MailChimpSync        MailChimpSync      ;
		public Guid        USER_ID;
		public bool        SyncAll;

		public UserSync(HttpSessionState Session, Security Security, SplendidError SplendidError, ExchangeSecurity ExchangeSecurity, SyncError SyncError, MailChimpSync MailChimpSync, Guid gUSER_ID, bool bSyncAll)
		{
		...
		public void Start()
		{
			...
			MailChimpSync.Sync(this, sbErrors);
