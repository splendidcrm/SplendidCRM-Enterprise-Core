...
namespace Spring.Social.Etsy
{
	public class LineItem : QObject
	{
		...
		public LineItem(HttpSessionState Session, Security Security, Sql Sql, SqlProcs SqlProcs, ExchangeSecurity ExchangeSecurity, SyncError SyncError, Spring.Social.Etsy.Api.IEtsy shopify, DataTable dtItems, Guid gSYNC_LOCAL_ID, string sSYNC_REMOTE_KEY, string sEtsyParentField, string sEtsyTableName, string sCRMModuleName, string sCRMTableName, string sCRMTableSort, string sCRMParentFieldName, bool bCRMAssignedUser)
			: base(Session, Security, Sql, SqlProcs, ExchangeSecurity, SyncError, shopify, sEtsyTableName, "ItemLineID", sCRMModuleName, sCRMTableName, sCRMTableSort, bCRMAssignedUser, false, false)
		{
			this.EtsyParentField = sEtsyParentField;
		...
		public void SetFromEtsy(DataRow row)
		{
