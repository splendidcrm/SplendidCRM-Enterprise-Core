...
namespace Spring.Social.Etsy
{
	public class UserSync
	{
		...
		private EtsySync             EtsySync           ;
		public Guid        USER_ID;
		public bool        SyncAll;

		public UserSync(HttpSessionState Session, Security Security, SplendidError SplendidError, ExchangeSecurity ExchangeSecurity, SyncError SyncError, EtsySync EtsySync, Guid gUSER_ID, bool bSyncAll)
		{
