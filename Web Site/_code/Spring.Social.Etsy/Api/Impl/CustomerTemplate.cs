...
namespace Spring.Social.Etsy.Api.Impl
{
	...
	{
		public CustomerTemplate(RestTemplate restTemplate, string shop_id) : base(restTemplate, shop_id, "customer")
		{
		}
		...
		public Customer GetById(string id)
		{
			...
			return this.restTemplate.GetForObject<Customer>("company/{shop_id}/" + this.moduleBase + "/{id}", shop_id, id);
		}
