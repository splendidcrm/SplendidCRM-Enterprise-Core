...
namespace Spring.Social.ConstantContact
{
	public class UserSync
	{
		...
		private ConstantContactSync  ConstantContactSync;
		public Guid        USER_ID;
		public bool        SyncAll;

		public UserSync(HttpSessionState Session, Security Security, SplendidError SplendidError, ExchangeSecurity ExchangeSecurity, SyncError SyncError, ConstantContactSync ConstantContactSync, Guid gUSER_ID, bool bSyncAll)
		{
		...
		public void Start()
		{
			...
			ConstantContactSync.Sync(this, sbErrors);
