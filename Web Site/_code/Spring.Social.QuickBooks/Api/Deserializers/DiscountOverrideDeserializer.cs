...
{
	class DiscountOverrideDeserializer : IJsonDeserializer
	{
		public object Deserialize(JsonValue json, JsonMapper mapper)
		{
			DiscountOverride obj = new DiscountOverride();
			...
			JsonValue discountRef        = json.GetValue("DiscountRef"       );
			JsonValue discountAccountRef = json.GetValue("DiscountAccountRef");
			if ( discountRef        != null && discountRef       .IsObject ) obj.DiscountRef        = mapper.Deserialize<ReferenceType>(discountRef       );
