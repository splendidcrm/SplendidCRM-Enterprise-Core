...
{
	// https://developer.intuit.com/docs/0025_quickbooksapi/0050_data_services/030_entity_services_reference/paymentmethod
	[Serializable]
	public class PaymentMethod : QBase
	{
		...
		{
			this.Active    = true         ;
			this.TypeValue = "CREDIT_CARD";  // This field is restricted to CREDIT_CARD or NON_CREDIT_CARD. 
		}

		public PaymentMethod(string sName)
		{
			this.Name      = sName        ;
			this.Active    = true         ;
			this.TypeValue = "CREDIT_CARD";  // This field is restricted to CREDIT_CARD or NON_CREDIT_CARD. 
		...
		public static DataRow ConvertToRow(PaymentMethod obj)
		{
			DataTable dt = PaymentMethod.CreateTable();
			DataRow row = dt.NewRow();
			obj.SetRow(row);
			return row;
		}

		public static DataTable ConvertToTable(IList<PaymentMethod> paymentMethods)
		{
			DataTable dt = PaymentMethod.CreateTable();
