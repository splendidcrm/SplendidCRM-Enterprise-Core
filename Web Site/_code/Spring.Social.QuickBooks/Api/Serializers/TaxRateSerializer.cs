...
{
	class TaxRateSerializer : IJsonSerializer
	{
		public JsonValue Serialize(object obj, JsonMapper mapper)
		{
			TaxRate o = obj as TaxRate;
			...
			if ( o.Rate             .HasValue      ) json.AddValue("RateValue"       , new JsonValue(o.Rate     .Value));
			if ( o.SpecialTaxType   .HasValue      ) json.AddValue("SpecialTaxType"  , _EnumSerializer.Serialize(o.SpecialTaxType.Value));
			if ( o.DisplayType      .HasValue      ) json.AddValue("DisplayType"     , _EnumSerializer.Serialize(o.DisplayType   .Value));
			if ( o.AgencyRef        != null        ) json.AddValue("AgencyRef"       , mapper.Serialize(o.AgencyRef       ));
			if ( o.TaxReturnLineRef != null        ) json.AddValue("TaxReturnLineRef", mapper.Serialize(o.TaxReturnLineRef));
			if ( o.EffectiveTaxRate != null        ) json.AddValue("EffectiveTaxRate", mapper.Serialize(o.EffectiveTaxRate));
	...
	class TaxRateListSerializer : IJsonSerializer
	{
		public JsonValue Serialize(object obj, JsonMapper mapper)
		{
