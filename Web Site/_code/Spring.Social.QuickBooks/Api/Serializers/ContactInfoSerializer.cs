...
{
	class ContactInfoSerializer : IJsonSerializer
	{
		public JsonValue Serialize(object obj, JsonMapper mapper)
		{
			ContactInfo o = obj as ContactInfo;
			
			JsonObject json = new JsonObject();
			if ( o.Type .HasValue ) json.AddValue("Type", _EnumSerializer.Serialize(o.Type.Value));
			if ( o.Item != null   ) json.AddValue("Item", mapper.Serialize(o.Item));
			return json;
		}
	}

	class ContactInfoListSerializer : IJsonSerializer
	{
		public JsonValue Serialize(object obj, JsonMapper mapper)
		{
