...
{
	class InvoiceTemplate : QBaseTemplate<Invoice>, IInvoiceOperations
	{
		public InvoiceTemplate(RestTemplate restTemplate, string companyId) : base(restTemplate, companyId, "invoice")
		{
		}

		public Invoice GetById(string id)
		{
			// https://qb.sbfinance.intuit.com/v3/company/{companyId}/invoice/{id}
			return this.restTemplate.GetForObject<Invoice>("company/{companyId}/" + this.tableName + "/{id}", companyId, id);
		}

		public Invoice Insert(Invoice obj)
		{
			string sURL = "company/" + companyId + "/" + this.tableName;
			return this.restTemplate.PostForObject<Invoice>(sURL, obj);
		}
