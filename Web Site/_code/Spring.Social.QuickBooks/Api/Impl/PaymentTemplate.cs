...
{
	class PaymentTemplate : QBaseTemplate<Payment>, IPaymentOperations
	{
		public PaymentTemplate(RestTemplate restTemplate, string companyId) : base(restTemplate, companyId, "payment")
		{
		}

		public Payment GetById(string id)
		{
			// https://qb.sbfinance.intuit.com/v3/company/{companyId}/Payment/{id}
			return this.restTemplate.GetForObject<Payment>("company/{companyId}/" + this.tableName + "/{id}", companyId, id);
		}

		public Payment Insert(Payment obj)
		{
			string sURL = "company/" + companyId + "/" + this.tableName;
			return this.restTemplate.PostForObject<Payment>(sURL, obj);
		}
