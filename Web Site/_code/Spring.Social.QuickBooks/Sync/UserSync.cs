...
namespace Spring.Social.QuickBooks
{
	public class UserSync
	{
		...
		private QuickBooksSync       QuickBooksSync     ;
		public Guid        USER_ID;
		public bool        SyncAll;

		public UserSync(HttpSessionState Session, Security Security, SplendidError SplendidError, ExchangeSecurity ExchangeSecurity, SyncError SyncError, QuickBooksSync QuickBooksSync, Guid gUSER_ID, bool bSyncAll)
		{
		...
		public void Start()
		{
			...
			QuickBooksSync.Sync(this, sbErrors);
