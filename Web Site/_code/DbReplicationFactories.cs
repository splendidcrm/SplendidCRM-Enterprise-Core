...
{
	/// <summary>
	/// Summary description for DbReplicationFactories.
	/// </summary>
	public class DbReplicationFactories
	{
		private SplendidCRM.DbProviderFactories  DbProviderFactories = new SplendidCRM.DbProviderFactories();
		private HttpApplicationState Application = new HttpApplicationState();
		private AppSettings          AppSettings = new AppSettings();

		public DbReplicationFactories()
		{
		}
		...
		public DbProviderFactory GetFactory()
		{
			...
			string sConnectionString = Sql.ToString(Application["ReplicationConnectionString"]);
#if DEBUG
			...
			if ( Sql.IsEmptyString(sSplendidProvider) || Sql.IsEmptyString(sConnectionString) )
			{
				...
				switch ( sSplendidProvider )
				{
					case "System.Data.SqlClient":
						sConnectionString = AppSettings["ReplicationSQLServer"];
						break;
					case "System.Data.OracleClient":
						sConnectionString = AppSettings["ReplicationSystemOracle"];
						break;
					case "Oracle.DataAccess.Client":
						sConnectionString = AppSettings["ReplicationOracle"];
						break;
					case "MySql.Data":
						sConnectionString = AppSettings["ReplicationMySql"];
						break;
					case "IBM.Data.DB2":
						sConnectionString = AppSettings["ReplicationDB2"];
						break;
					case "Sybase.Data.AseClient":
						sConnectionString = AppSettings["ReplicationSybase"];
						break;
					case "iAnywhere.Data.AsaClient":
						sConnectionString = AppSettings["ReplicationSQLAnywhere"];
						break;
					case "Npgsql":
						sConnectionString = AppSettings["ReplicationNpgsql"];
						break;
					case "Registry":
					{
...
#pragma warning disable CA1416
						using (RegistryKey keySplendidCRM = Registry.LocalMachine.OpenSubKey(sSplendidRegistry))
						{
							if ( keySplendidCRM != null )
							{
								...
								sConnectionString = Sql.ToString(keySplendidCRM.GetValue("ReplicationConnectionString"));
...
#pragma warning restore CA1416
				...
				Application["ReplicationConnectionString"] = sConnectionString;
			}
