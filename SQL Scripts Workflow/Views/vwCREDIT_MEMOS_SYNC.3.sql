if exists (select * from INFORMATION_SCHEMA.VIEWS where TABLE_NAME = 'vwCREDIT_MEMOS_SYNC')
	Drop View dbo.vwCREDIT_MEMOS_SYNC;
GO
 ...
 * 
 *********************************************************************************************************************/
Create View dbo.vwCREDIT_MEMOS_SYNC
as
...
Grant Select on dbo.vwCREDIT_MEMOS_SYNC to public;
GO
