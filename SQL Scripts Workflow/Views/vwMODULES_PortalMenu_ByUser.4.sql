if exists (select * from INFORMATION_SCHEMA.VIEWS where TABLE_NAME = 'vwMODULES_PortalMenu_ByUser')
	Drop View dbo.vwMODULES_PortalMenu_ByUser;
GO
...
Create View dbo.vwMODULES_PortalMenu_ByUser
as
select vwMODULES_USERS_Cross.USER_ID
 ...
 where vwMODULES_USERS_Cross.MODULE_ENABLED = 1
   and vwMODULES_USERS_Cross.PORTAL_ENABLED = 1
...
Grant Select on dbo.vwMODULES_PortalMenu_ByUser to public;
GO
