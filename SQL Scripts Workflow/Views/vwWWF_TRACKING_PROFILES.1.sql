if exists (select * from INFORMATION_SCHEMA.VIEWS where TABLE_NAME = 'vwWWF_TRACKING_PROFILES')
	Drop View dbo.vwWWF_TRACKING_PROFILES;
GO
 ...
 * 
 *********************************************************************************************************************/
Create View dbo.vwWWF_TRACKING_PROFILES
as
...
Grant Select on dbo.vwWWF_TRACKING_PROFILES to public;
GO
