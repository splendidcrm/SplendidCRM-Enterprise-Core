if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spTAX_RATES_SYNC_Update' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spTAX_RATES_SYNC_Update;
GO
 ...
 * 
 *********************************************************************************************************************/
Create Procedure dbo.spTAX_RATES_SYNC_Update
...
Grant Execute on dbo.spTAX_RATES_SYNC_Update to public;
GO
