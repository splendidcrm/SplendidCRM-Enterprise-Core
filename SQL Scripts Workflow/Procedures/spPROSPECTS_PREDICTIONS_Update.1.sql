if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spPROSPECTS_PREDICTIONS_Update' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spPROSPECTS_PREDICTIONS_Update;
GO
 ...
 * 
 *********************************************************************************************************************/
Create Procedure dbo.spPROSPECTS_PREDICTIONS_Update
...
as
  begin
	...
	if dbo.fnIsEmptyGuid(@ID) = 1 begin -- then
		set @ID = newid();
		insert into PROSPECTS_PREDICTIONS
			( ID               
			, CREATED_BY       
			, DATE_ENTERED     
			, MODIFIED_USER_ID 
...
Grant Execute on dbo.spPROSPECTS_PREDICTIONS_Update to public;
GO
