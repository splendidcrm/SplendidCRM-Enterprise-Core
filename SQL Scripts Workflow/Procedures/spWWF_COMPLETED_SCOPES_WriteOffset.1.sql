if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spWWF_COMPLETED_SCOPES_WriteOffset' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spWWF_COMPLETED_SCOPES_WriteOffset;
GO
...
Create Procedure dbo.spWWF_COMPLETED_SCOPES_WriteOffset
	( @ID                   uniqueidentifier
...
-- #if SQL_Server /*
	...
	-- updatetext WWF_COMPLETED_SCOPES.STATE
	--            @FILE_POINTER
	--            @FILE_OFFSET
...
Grant Execute on dbo.spWWF_COMPLETED_SCOPES_WriteOffset to public;
GO
