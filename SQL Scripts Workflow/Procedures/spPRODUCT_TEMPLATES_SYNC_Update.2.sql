if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spPRODUCT_TEMPLATES_SYNC_Update' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spPRODUCT_TEMPLATES_SYNC_Update;
GO
 ...
 * 
 *********************************************************************************************************************/
Create Procedure dbo.spPRODUCT_TEMPLATES_SYNC_Update
...
as
  begin
	...
	if dbo.fnIsEmptyGuid(@ID) = 1 begin -- then
		set @ID = newid();
		insert into PRODUCT_TEMPLATES_SYNC
			( ID                      
			, CREATED_BY              
			, DATE_ENTERED            
			, MODIFIED_USER_ID        
...
Grant Execute on dbo.spPRODUCT_TEMPLATES_SYNC_Update to public;
GO
