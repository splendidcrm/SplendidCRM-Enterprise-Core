if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spCONTACTS_PREDICTIONS_Update' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spCONTACTS_PREDICTIONS_Update;
GO
 ...
 * 
 *********************************************************************************************************************/
Create Procedure dbo.spCONTACTS_PREDICTIONS_Update
...
as
  begin
	...
	if dbo.fnIsEmptyGuid(@ID) = 1 begin -- then
		set @ID = newid();
		insert into CONTACTS_PREDICTIONS
			( ID               
			, CREATED_BY       
			, DATE_ENTERED     
			, MODIFIED_USER_ID 
...
Grant Execute on dbo.spCONTACTS_PREDICTIONS_Update to public;
GO
