if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spWWF_INSTANCE_STATES_WriteOffset' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spWWF_INSTANCE_STATES_WriteOffset;
GO
...
Create Procedure dbo.spWWF_INSTANCE_STATES_WriteOffset
	( @ID                   uniqueidentifier
...
-- #if SQL_Server /*
	...
	-- updatetext WWF_INSTANCE_STATES.STATE
	--            @FILE_POINTER
	--            @FILE_OFFSET
...
Grant Execute on dbo.spWWF_INSTANCE_STATES_WriteOffset to public;
GO
