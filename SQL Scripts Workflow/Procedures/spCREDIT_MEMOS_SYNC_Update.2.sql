if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spCREDIT_MEMOS_SYNC_Update' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spCREDIT_MEMOS_SYNC_Update;
GO
 ...
 * 
 *********************************************************************************************************************/
Create Procedure dbo.spCREDIT_MEMOS_SYNC_Update
...
Grant Execute on dbo.spCREDIT_MEMOS_SYNC_Update to public;
GO
