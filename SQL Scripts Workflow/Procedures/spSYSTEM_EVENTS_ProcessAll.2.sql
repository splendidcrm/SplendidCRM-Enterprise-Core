 ...
 * 
 *********************************************************************************************************************/
-- 01/27/2009 Paul.  Provide a do-nothing procedure so that a Professional instance can run on an Enterprise database. 
-- 02/26/2010 Paul.  This procedure was previously stubbed-out, but we do want systems events to be cleaned after use. 
-- We could just delete this procedure in the Workflow folder, but it may remain on a customer machine. 
