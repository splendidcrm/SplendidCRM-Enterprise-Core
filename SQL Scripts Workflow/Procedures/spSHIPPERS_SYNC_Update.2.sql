if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spSHIPPERS_SYNC_Update' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spSHIPPERS_SYNC_Update;
GO
 ...
 * 
 *********************************************************************************************************************/
Create Procedure dbo.spSHIPPERS_SYNC_Update
...
Grant Execute on dbo.spSHIPPERS_SYNC_Update to public;
GO
