if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spWF4_TRACKING_CANCEL_REQUESTED_Insert' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spWF4_TRACKING_CANCEL_REQUESTED_Insert;
GO
 ...
 * 
 *********************************************************************************************************************/
Create Procedure dbo.spWF4_TRACKING_CANCEL_REQUESTED_Insert
...
as
  begin
	...
	set @ID = newid();
	insert into WF4_TRACKING_CANCEL_REQUESTED
		( ID                         
		, CREATED_BY                 
		, DATE_ENTERED               
		, INSTANCE_ID                
...
Grant Execute on dbo.spWF4_TRACKING_CANCEL_REQUESTED_Insert to public;
GO
