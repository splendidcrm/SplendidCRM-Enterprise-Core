...
if not exists(select * from EDITVIEWS_RELATIONSHIPS where EDIT_NAME = 'Accounts.EditView' and DELETED = 0) begin -- then
	...
	exec dbo.spEDITVIEWS_RELATIONSHIPS_InsertOnly 'Accounts.EditView', 'Contracts'    , '~/Contracts/NewRecord'    ,  0,  4, 1, 0, 'Contracts.LBL_NEW_FORM_TITLE'    , 'EditView.Inline.Accounts';
end -- if;
GO
