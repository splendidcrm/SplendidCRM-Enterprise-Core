if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spCALLS_MassAssign' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spCALLS_MassAssign;
GO
...
Create Procedure dbo.spCALLS_MassAssign
...
Grant Execute on dbo.spCALLS_MassAssign to public;
GO
