if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spOPPORTUNITIES_MassSync' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spOPPORTUNITIES_MassSync;
GO
 ...
 * 
 *********************************************************************************************************************/
Create Procedure dbo.spOPPORTUNITIES_MassSync
...
Grant Execute on dbo.spOPPORTUNITIES_MassSync to public;
GO
