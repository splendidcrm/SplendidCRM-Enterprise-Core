if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spEMAILMAN_MassDelete' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spEMAILMAN_MassDelete;
GO
 ...
 * 
 *********************************************************************************************************************/
Create Procedure dbo.spEMAILMAN_MassDelete
...
Grant Execute on dbo.spEMAILMAN_MassDelete to public;
GO
