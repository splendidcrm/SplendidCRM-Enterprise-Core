if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spQUOTES_MassAssign' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spQUOTES_MassAssign;
GO
...
Create Procedure dbo.spQUOTES_MassAssign
...
Grant Execute on dbo.spQUOTES_MassAssign to public;
GO
