if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spBUGS_MassUnsync' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spBUGS_MassUnsync;
GO
 ...
 * 
 *********************************************************************************************************************/
Create Procedure dbo.spBUGS_MassUnsync
...
Grant Execute on dbo.spBUGS_MassUnsync to public;
GO
