if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spCALLS_UpdateAcceptStatus' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spCALLS_UpdateAcceptStatus;
GO
 ...
 * 
 *********************************************************************************************************************/
Create Procedure dbo.spCALLS_UpdateAcceptStatus
	( @ID                 uniqueidentifier
...
Grant Execute on dbo.spCALLS_UpdateAcceptStatus to public;
GO
