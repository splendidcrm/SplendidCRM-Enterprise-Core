if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spREPORTS_MassAssign' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spREPORTS_MassAssign;
GO
...
Create Procedure dbo.spREPORTS_MassAssign
...
Grant Execute on dbo.spREPORTS_MassAssign to public;
GO
