if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spPROSPECTS_MassRedist' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spPROSPECTS_MassRedist;
GO
...
Create Procedure dbo.spPROSPECTS_MassRedist
	( @ID_LIST           varchar(max)
...
Grant Execute on dbo.spPROSPECTS_MassRedist to public;
GO
