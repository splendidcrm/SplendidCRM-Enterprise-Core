if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spCAMPAIGNS_MassUpdate' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spCAMPAIGNS_MassUpdate;
GO
...
Create Procedure dbo.spCAMPAIGNS_MassUpdate
		...
		-- BEGIN Oracle Exception
			update CAMPAIGNS
			   set MODIFIED_USER_ID  = @MODIFIED_USER_ID 
			     ...
			     , CAMPAIGN_TYPE     = isnull(@CAMPAIGN_TYPE   , CAMPAIGN_TYPE   )
			     , ASSIGNED_USER_ID  = isnull(@ASSIGNED_USER_ID, ASSIGNED_USER_ID)
...
Grant Execute on dbo.spCAMPAIGNS_MassUpdate to public;
GO
