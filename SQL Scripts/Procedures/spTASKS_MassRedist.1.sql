if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spTASKS_MassRedist' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spTASKS_MassRedist;
GO
...
Create Procedure dbo.spTASKS_MassRedist
	( @ID_LIST           varchar(max)
...
Grant Execute on dbo.spTASKS_MassRedist to public;
GO
