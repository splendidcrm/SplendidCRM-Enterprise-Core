if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spKBDOCUMENTS_MassRedist' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spKBDOCUMENTS_MassRedist;
GO
...
Create Procedure dbo.spKBDOCUMENTS_MassRedist
	( @ID_LIST           varchar(max)
...
Grant Execute on dbo.spKBDOCUMENTS_MassRedist to public;
GO
