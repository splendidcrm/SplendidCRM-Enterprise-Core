if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spCALLS_EmailReminderSent' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spCALLS_EmailReminderSent;
GO
 ...
 * 
 *********************************************************************************************************************/
Create Procedure dbo.spCALLS_EmailReminderSent
	( @ID                 uniqueidentifier
...
Grant Execute on dbo.spCALLS_EmailReminderSent to public;
GO
