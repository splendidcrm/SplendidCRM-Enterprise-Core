if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spORDERS_MassAssign' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spORDERS_MassAssign;
GO
...
Create Procedure dbo.spORDERS_MassAssign
...
Grant Execute on dbo.spORDERS_MassAssign to public;
GO
