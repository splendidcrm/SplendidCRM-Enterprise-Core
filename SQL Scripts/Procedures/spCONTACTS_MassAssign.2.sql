if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spCONTACTS_MassAssign' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spCONTACTS_MassAssign;
GO
...
Create Procedure dbo.spCONTACTS_MassAssign
...
Grant Execute on dbo.spCONTACTS_MassAssign to public;
GO
