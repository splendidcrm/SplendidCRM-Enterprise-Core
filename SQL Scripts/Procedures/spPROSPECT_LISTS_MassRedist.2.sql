if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spPROSPECT_LISTS_MassRedist' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spPROSPECT_LISTS_MassRedist;
GO
...
Create Procedure dbo.spPROSPECT_LISTS_MassRedist
	( @ID_LIST           varchar(max)
...
Grant Execute on dbo.spPROSPECT_LISTS_MassRedist to public;
GO
