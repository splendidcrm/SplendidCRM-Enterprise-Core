if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spNOTES_ATTACHMENT_WriteOffset' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spNOTES_ATTACHMENT_WriteOffset;
GO
...
Create Procedure dbo.spNOTES_ATTACHMENT_WriteOffset
	( @ID                   uniqueidentifier
...
-- #if SQL_Server /*
	...
	-- updatetext NOTE_ATTACHMENTS.ATTACHMENT
	--            @FILE_POINTER
	--            @FILE_OFFSET
...
Grant Execute on dbo.spNOTES_ATTACHMENT_WriteOffset to public;
GO
