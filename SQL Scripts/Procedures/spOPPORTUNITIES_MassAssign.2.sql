if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spOPPORTUNITIES_MassAssign' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spOPPORTUNITIES_MassAssign;
GO
...
Create Procedure dbo.spOPPORTUNITIES_MassAssign
...
Grant Execute on dbo.spOPPORTUNITIES_MassAssign to public;
GO
