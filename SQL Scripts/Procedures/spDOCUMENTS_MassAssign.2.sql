if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spDOCUMENTS_MassAssign' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spDOCUMENTS_MassAssign;
GO
...
Create Procedure dbo.spDOCUMENTS_MassAssign
...
Grant Execute on dbo.spDOCUMENTS_MassAssign to public;
GO
