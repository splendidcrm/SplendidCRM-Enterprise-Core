if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spPROJECT_TASK_MassRedist' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spPROJECT_TASK_MassRedist;
GO
...
Create Procedure dbo.spPROJECT_TASK_MassRedist
	( @ID_LIST           varchar(max)
...
Grant Execute on dbo.spPROJECT_TASK_MassRedist to public;
GO
