if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spQUOTES_Delete' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spQUOTES_Delete;
GO
 ...
 * 
 *********************************************************************************************************************/
-- 12/16/2008 Paul.  Delete the quote relationships. 
...
Create Procedure dbo.spQUOTES_Delete
	( @ID               uniqueidentifier
...
Grant Execute on dbo.spQUOTES_Delete to public;
GO
