if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spFEEDS_MassAssign' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spFEEDS_MassAssign;
GO
...
Create Procedure dbo.spFEEDS_MassAssign
...
Grant Execute on dbo.spFEEDS_MassAssign to public;
GO
