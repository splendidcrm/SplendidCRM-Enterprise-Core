if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spPROSPECTS_MassAssign' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spPROSPECTS_MassAssign;
GO
...
Create Procedure dbo.spPROSPECTS_MassAssign
...
Grant Execute on dbo.spPROSPECTS_MassAssign to public;
GO
