if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spDOCUMENTS_MassRedist' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spDOCUMENTS_MassRedist;
GO
...
Create Procedure dbo.spDOCUMENTS_MassRedist
	( @ID_LIST           varchar(max)
...
Grant Execute on dbo.spDOCUMENTS_MassRedist to public;
GO
