if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spTASKS_Delete' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spTASKS_Delete;
GO
...
Grant Execute on dbo.spTASKS_Delete to public;
GO
