if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spCALLS_MassUpdate' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spCALLS_MassUpdate;
GO
...
Create Procedure dbo.spCALLS_MassUpdate
...
Grant Execute on dbo.spCALLS_MassUpdate to public;
GO
