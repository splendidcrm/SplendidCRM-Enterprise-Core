if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spPROJECTS_Delete' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spPROJECTS_Delete;
GO
...
Grant Execute on dbo.spPROJECTS_Delete to public;
GO
