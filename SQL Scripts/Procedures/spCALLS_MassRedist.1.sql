if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spCALLS_MassRedist' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spCALLS_MassRedist;
GO
...
Create Procedure dbo.spCALLS_MassRedist
	( @ID_LIST           varchar(max)
...
Grant Execute on dbo.spCALLS_MassRedist to public;
GO
