if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spFEEDS_MassRedist' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spFEEDS_MassRedist;
GO
 ...
 * 
 *********************************************************************************************************************/
Create Procedure dbo.spFEEDS_MassRedist
	( @ID_LIST           varchar(max)
...
Grant Execute on dbo.spFEEDS_MassRedist to public;
GO
