if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spSURVEY_THEMES_InsertOnly' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spSURVEY_THEMES_InsertOnly;
GO
...
Create Procedure dbo.spSURVEY_THEMES_InsertOnly
	( @ID                            uniqueidentifier
	, @NAME                          nvarchar(50)
...
Grant Execute on dbo.spSURVEY_THEMES_InsertOnly to public;
GO
