if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spCASES_MassSync' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spCASES_MassSync;
GO
 ...
 * 
 *********************************************************************************************************************/
Create Procedure dbo.spCASES_MassSync
...
Grant Execute on dbo.spCASES_MassSync to public;
GO
