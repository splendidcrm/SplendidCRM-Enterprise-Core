if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spPROJECT_TASK_MassAssign' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spPROJECT_TASK_MassAssign;
GO
...
Create Procedure dbo.spPROJECT_TASK_MassAssign
...
Grant Execute on dbo.spPROJECT_TASK_MassAssign to public;
GO
