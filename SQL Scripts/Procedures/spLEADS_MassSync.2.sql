if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spLEADS_MassSync' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spLEADS_MassSync;
GO
 ...
 * 
 *********************************************************************************************************************/
Create Procedure dbo.spLEADS_MassSync
...
Grant Execute on dbo.spLEADS_MassSync to public;
GO
