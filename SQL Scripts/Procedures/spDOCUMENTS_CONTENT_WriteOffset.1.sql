if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spDOCUMENTS_CONTENT_WriteOffset' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spDOCUMENTS_CONTENT_WriteOffset;
GO
...
Create Procedure dbo.spDOCUMENTS_CONTENT_WriteOffset
	( @ID                   uniqueidentifier
...
-- #if SQL_Server /*
	...
	-- updatetext DOCUMENT_REVISIONS.CONTENT
	--            @FILE_POINTER
	--            @FILE_OFFSET
...
Grant Execute on dbo.spDOCUMENTS_CONTENT_WriteOffset to public;
GO
