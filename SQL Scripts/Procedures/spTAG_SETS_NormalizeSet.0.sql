if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spTAG_SETS_NormalizeSet' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spTAG_SETS_NormalizeSet;
GO
 ...
 * 
 *********************************************************************************************************************/
Create Procedure dbo.spTAG_SETS_NormalizeSet
...
Grant Execute on dbo.spTAG_SETS_NormalizeSet to public;
GO
