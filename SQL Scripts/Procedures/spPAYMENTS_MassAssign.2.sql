if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spPAYMENTS_MassAssign' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spPAYMENTS_MassAssign;
GO
...
Create Procedure dbo.spPAYMENTS_MassAssign
...
Grant Execute on dbo.spPAYMENTS_MassAssign to public;
GO
