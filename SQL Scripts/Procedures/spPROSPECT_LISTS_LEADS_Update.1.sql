if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spPROSPECT_LISTS_LEADS_Update' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spPROSPECT_LISTS_LEADS_Update;
GO
...
Create Procedure dbo.spPROSPECT_LISTS_LEADS_Update
...
Grant Execute on dbo.spPROSPECT_LISTS_LEADS_Update to public;
GO
