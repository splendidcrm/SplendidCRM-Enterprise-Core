if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spCAMPAIGNS_MassAssign' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spCAMPAIGNS_MassAssign;
GO
...
Create Procedure dbo.spCAMPAIGNS_MassAssign
...
Grant Execute on dbo.spCAMPAIGNS_MassAssign to public;
GO
