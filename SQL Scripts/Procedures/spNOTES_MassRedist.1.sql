if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spNOTES_MassRedist' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spNOTES_MassRedist;
GO
...
Create Procedure dbo.spNOTES_MassRedist
	( @ID_LIST           varchar(max)
...
Grant Execute on dbo.spNOTES_MassRedist to public;
GO
