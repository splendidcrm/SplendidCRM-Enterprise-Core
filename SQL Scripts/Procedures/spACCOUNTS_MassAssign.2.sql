if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spACCOUNTS_MassAssign' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spACCOUNTS_MassAssign;
GO
...
Create Procedure dbo.spACCOUNTS_MassAssign
...
Grant Execute on dbo.spACCOUNTS_MassAssign to public;
GO
