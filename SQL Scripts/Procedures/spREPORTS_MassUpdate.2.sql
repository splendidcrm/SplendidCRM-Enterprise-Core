if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spREPORTS_MassUpdate' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spREPORTS_MassUpdate;
GO
...
Create Procedure dbo.spREPORTS_MassUpdate
...
Grant Execute on dbo.spREPORTS_MassUpdate to public;
GO
