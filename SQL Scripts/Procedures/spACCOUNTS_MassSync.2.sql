if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spACCOUNTS_MassSync' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spACCOUNTS_MassSync;
GO
 ...
 * 
 *********************************************************************************************************************/
Create Procedure dbo.spACCOUNTS_MassSync
...
Grant Execute on dbo.spACCOUNTS_MassSync to public;
GO
