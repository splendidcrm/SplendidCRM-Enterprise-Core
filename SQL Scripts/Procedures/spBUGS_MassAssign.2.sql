if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spBUGS_MassAssign' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spBUGS_MassAssign;
GO
...
Create Procedure dbo.spBUGS_MassAssign
...
Grant Execute on dbo.spBUGS_MassAssign to public;
GO
