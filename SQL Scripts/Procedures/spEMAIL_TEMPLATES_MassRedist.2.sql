if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spEMAIL_TEMPLATES_MassRedist' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spEMAIL_TEMPLATES_MassRedist;
GO
...
Create Procedure dbo.spEMAIL_TEMPLATES_MassRedist
	( @ID_LIST           varchar(max)
...
Grant Execute on dbo.spEMAIL_TEMPLATES_MassRedist to public;
GO
