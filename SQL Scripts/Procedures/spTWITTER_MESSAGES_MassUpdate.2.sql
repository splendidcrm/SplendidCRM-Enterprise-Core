if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spTWITTER_MESSAGES_MassUpdate' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spTWITTER_MESSAGES_MassUpdate;
GO
...
Create Procedure dbo.spTWITTER_MESSAGES_MassUpdate
...
Grant Execute on dbo.spTWITTER_MESSAGES_MassUpdate to public;
GO
