if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spBUGS_New' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spBUGS_New;
GO
...
Create Procedure dbo.spBUGS_New
...
Grant Execute on dbo.spBUGS_New to public;
GO
