if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spORDERS_Delete' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spORDERS_Delete;
GO
 ...
 * 
 *********************************************************************************************************************/
-- 12/16/2008 Paul.  Delete the order relationships. 
...
Grant Execute on dbo.spORDERS_Delete to public;
GO
