if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spREPORTS_MassRedist' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spREPORTS_MassRedist;
GO
 ...
 * 
 *********************************************************************************************************************/
Create Procedure dbo.spREPORTS_MassRedist
	( @ID_LIST           varchar(max)
...
Grant Execute on dbo.spREPORTS_MassRedist to public;
GO
