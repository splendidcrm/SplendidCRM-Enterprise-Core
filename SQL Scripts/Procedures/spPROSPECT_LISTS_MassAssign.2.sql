if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spPROSPECT_LISTS_MassAssign' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spPROSPECT_LISTS_MassAssign;
GO
...
Create Procedure dbo.spPROSPECT_LISTS_MassAssign
...
Grant Execute on dbo.spPROSPECT_LISTS_MassAssign to public;
GO
