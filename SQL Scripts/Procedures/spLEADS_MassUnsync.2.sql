if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spLEADS_MassUnsync' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spLEADS_MassUnsync;
GO
 ...
 * 
 *********************************************************************************************************************/
Create Procedure dbo.spLEADS_MassUnsync
...
Grant Execute on dbo.spLEADS_MassUnsync to public;
GO
