if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spEMAILS_MassUpdate' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spEMAILS_MassUpdate;
GO
...
Create Procedure dbo.spEMAILS_MassUpdate
...
Grant Execute on dbo.spEMAILS_MassUpdate to public;
GO
