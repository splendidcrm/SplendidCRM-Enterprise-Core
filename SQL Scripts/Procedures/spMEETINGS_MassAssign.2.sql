if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spMEETINGS_MassAssign' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spMEETINGS_MassAssign;
GO
...
Create Procedure dbo.spMEETINGS_MassAssign
...
Grant Execute on dbo.spMEETINGS_MassAssign to public;
GO
