if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spPROJECT_TASKS_New' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spPROJECT_TASKS_New;
GO
...
Create Procedure dbo.spPROJECT_TASKS_New
...
Grant Execute on dbo.spPROJECT_TASKS_New to public;
GO
