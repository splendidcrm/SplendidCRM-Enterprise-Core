if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spINVOICES_MassAssign' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spINVOICES_MassAssign;
GO
...
Create Procedure dbo.spINVOICES_MassAssign
...
Grant Execute on dbo.spINVOICES_MassAssign to public;
GO
