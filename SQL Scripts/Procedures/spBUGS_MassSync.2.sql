if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spBUGS_MassSync' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spBUGS_MassSync;
GO
 ...
 * 
 *********************************************************************************************************************/
Create Procedure dbo.spBUGS_MassSync
...
Grant Execute on dbo.spBUGS_MassSync to public;
GO
