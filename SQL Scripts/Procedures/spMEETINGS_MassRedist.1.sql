if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spMEETINGS_MassRedist' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spMEETINGS_MassRedist;
GO
...
Create Procedure dbo.spMEETINGS_MassRedist
	( @ID_LIST           varchar(max)
...
Grant Execute on dbo.spMEETINGS_MassRedist to public;
GO
