if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spTASKS_MassAssign' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spTASKS_MassAssign;
GO
...
Create Procedure dbo.spTASKS_MassAssign
...
Grant Execute on dbo.spTASKS_MassAssign to public;
GO
