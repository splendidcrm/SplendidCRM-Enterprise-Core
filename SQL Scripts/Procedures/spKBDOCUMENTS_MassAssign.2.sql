if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spKBDOCUMENTS_MassAssign' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spKBDOCUMENTS_MassAssign;
GO
...
Create Procedure dbo.spKBDOCUMENTS_MassAssign
...
Grant Execute on dbo.spKBDOCUMENTS_MassAssign to public;
GO
