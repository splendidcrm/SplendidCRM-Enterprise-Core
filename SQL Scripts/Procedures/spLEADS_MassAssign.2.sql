if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spLEADS_MassAssign' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spLEADS_MassAssign;
GO
...
Create Procedure dbo.spLEADS_MassAssign
...
Grant Execute on dbo.spLEADS_MassAssign to public;
GO
