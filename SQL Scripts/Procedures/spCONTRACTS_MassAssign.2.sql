if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spCONTRACTS_MassAssign' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spCONTRACTS_MassAssign;
GO
...
Create Procedure dbo.spCONTRACTS_MassAssign
...
Grant Execute on dbo.spCONTRACTS_MassAssign to public;
GO
