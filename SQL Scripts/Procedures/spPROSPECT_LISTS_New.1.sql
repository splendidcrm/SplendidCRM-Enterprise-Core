if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spPROSPECT_LISTS_New' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spPROSPECT_LISTS_New;
GO
...
Create Procedure dbo.spPROSPECT_LISTS_New
...
Grant Execute on dbo.spPROSPECT_LISTS_New to public;
GO
