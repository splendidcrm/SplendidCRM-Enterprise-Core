if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spSURVEY_QUESTIONS_MassUpdate' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spSURVEY_QUESTIONS_MassUpdate;
GO
...
Create Procedure dbo.spSURVEY_QUESTIONS_MassUpdate
...
Grant Execute on dbo.spSURVEY_QUESTIONS_MassUpdate to public;
GO
