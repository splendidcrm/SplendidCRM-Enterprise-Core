if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spMEETINGS_MassUpdate' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spMEETINGS_MassUpdate;
GO
...
Create Procedure dbo.spMEETINGS_MassUpdate
...
as
  begin
	...
	set @DATE_START = dbo.fnDateOnly(@DATE_TIME);
...
Grant Execute on dbo.spMEETINGS_MassUpdate to public;
GO
