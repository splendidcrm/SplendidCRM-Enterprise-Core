if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spCHARTS_MassUpdate' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spCHARTS_MassUpdate;
GO
...
Create Procedure dbo.spCHARTS_MassUpdate
...
Grant Execute on dbo.spCHARTS_MassUpdate to public;
GO
