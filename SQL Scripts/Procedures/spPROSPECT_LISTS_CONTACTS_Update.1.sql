if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spPROSPECT_LISTS_CONTACTS_Update' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spPROSPECT_LISTS_CONTACTS_Update;
GO
...
Create Procedure dbo.spPROSPECT_LISTS_CONTACTS_Update
...
Grant Execute on dbo.spPROSPECT_LISTS_CONTACTS_Update to public;
GO
