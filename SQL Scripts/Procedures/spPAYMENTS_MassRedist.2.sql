if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spPAYMENTS_MassRedist' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spPAYMENTS_MassRedist;
GO
...
Create Procedure dbo.spPAYMENTS_MassRedist
	( @ID_LIST           varchar(max)
...
Grant Execute on dbo.spPAYMENTS_MassRedist to public;
GO
