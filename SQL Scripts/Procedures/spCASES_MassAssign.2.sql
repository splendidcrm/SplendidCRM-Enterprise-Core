if exists (select * from INFORMATION_SCHEMA.ROUTINES where ROUTINE_NAME = 'spCASES_MassAssign' and ROUTINE_TYPE = 'PROCEDURE')
	Drop Procedure dbo.spCASES_MassAssign;
GO
...
Create Procedure dbo.spCASES_MassAssign
...
Grant Execute on dbo.spCASES_MassAssign to public;
GO
