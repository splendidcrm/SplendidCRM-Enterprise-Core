...
print 'REPORTS Active User Sessions (Last 7 Days)';
GO

set nocount on;
GO

-- delete from REPORTS where ID = 'F6985DEA-C371-4944-B97D-E759ED1E8A52';
exec dbo.spREPORTS_InsertOnly 'F6985DEA-C371-4944-B97D-E759ED1E8A52', 'Active User Sessions (Last 7 Days)', 'Trackers', 'Freeform', '<?xml version="1.0" encoding="utf-8"?>
	...
	<DataSets>
		<DataSet Name="vwUSERS_LOGINS">
			<Query>
				...
				<CommandText>select cast(USER_ID as char(36)) as USER_ID
     , USER_NAME
     , FULL_NAME
     , LOGIN_DATE
  from vwUSERS_LOGINS
 where LOGIN_DATE &gt; dbo.fnDateAdd(''day'', -7, getdate())
   and LOGIN_STATUS = ''Succeeded''
 order by LOGIN_DATE desc</CommandText>
			</Query>
			<Fields>
				<Field Name="USER_ID">
											...
											<CellContents>
												<Textbox Name="USER_NAME__Value">
													...
													<ActionInfo>
														<Actions>
															<Action>
																<Hyperlink>="~/Users/view.aspx?ID=" + Fields!USER_ID.Value</Hyperlink>
															</Action>
														</Actions>
													</ActionInfo>
													<Style>
												...
												<Textbox Name="LOGIN_DATE_Value">
													...
													<Paragraphs>
														<Paragraph>
															<TextRuns>
																<TextRun>
																	<Value>=Fields!LOGIN_DATE.Value</Value>
																	<Style />
																</TextRun>
															</TextRuns>
															<Style>
	...
	<rd:ReportID>F6985DEA-C371-4944-B97D-E759ED1E8A52</rd:ReportID>
...
call dbo.spREPORTS_Active_User_Sessions()
/

call dbo.spSqlDropProcedure('spREPORTS_Active_User_Sessions')
/
