...
print 'REPORTS Leads By Lead Source';
GO

set nocount on;
GO

-- delete from REPORTS where ID = '0A4258C5-8C49-4E9A-9139-12F278AFCC52';
exec dbo.spREPORTS_InsertOnly '0A4258C5-8C49-4E9A-9139-12F278AFCC52', 'Leads By Lead Source', 'Leads', 'Freeform', '<?xml version="1.0" encoding="utf-8"?>
   ...
   and (TEAM_ID is null or vwTEAM_MEMBERSHIPS.MEMBERSHIP_TEAM_ID is not null)
				...
				<rd:DesignerState>
					<QueryDefinition xmlns="http://schemas.microsoft.com/ReportingServices/QueryDefinition/Relational">
						<SelectedColumns>
							<ColumnExpression ColumnOwner="vwLEADS" ColumnName="LEAD_SOURCE" GroupBy="True" />
						</SelectedColumns>
					</QueryDefinition>
				</rd:DesignerState>
			</Query>
			...
			<Body>
				<ReportItems>
					<Tablix Name="Tablix1">
						...
						<DataSetName>vwLEADS</DataSetName>
						<Top>6.5in</Top>
						<Height>0.5in</Height>
						<Width>8.5in</Width>
						<Style>
					...
					<Chart Name="Chart1">
									...
									<ChartDataPoints>
										<ChartDataPoint>
											...
											<ActionInfo>
												<Actions>
													<Action>
														<Hyperlink>="~/Leads/default.aspx?LEAD_SOURCE=" + Fields!LEAD_SOURCE.Value</Hyperlink>
													</Action>
												</Actions>
											</ActionInfo>
											<Style />
						...
						<ChartTitles>
							<ChartTitle Name="Default">
								<Caption>Leads By Lead Source</Caption>
								<Style>
									<BackgroundGradientType>None</BackgroundGradientType>
									<FontFamily>Tahoma</FontFamily>
	...
	<rd:ReportID>0A4258C5-8C49-4E9A-9139-12F278AFCC52</rd:ReportID>
...
call dbo.spREPORTS_Leads_By_Lead_Source()
/

call dbo.spSqlDropProcedure('spREPORTS_Leads_By_Lead_Source')
/
