...
print 'REPORTS Tasks By Team By User';
GO

set nocount on;
GO

-- delete from REPORTS where ID = '14B9FBCE-25DE-451C-8C18-4DC4600462E1';
exec dbo.spREPORTS_InsertOnly '14B9FBCE-25DE-451C-8C18-4DC4600462E1', 'Tasks By Team By User', 'Tasks', 'Freeform', '<?xml version="1.0" encoding="utf-8"?>
   ...
   and (TEAM_ID is null or vwTEAM_MEMBERSHIPS.MEMBERSHIP_TEAM_ID is not null)
				...
				<rd:DesignerState>
					<QueryDefinition xmlns="http://schemas.microsoft.com/ReportingServices/QueryDefinition/Relational">
						<SelectedColumns>
							<ColumnExpression ColumnOwner="vwTASKS" ColumnName="TEAM_NAME" GroupBy="True" />
							<ColumnExpression ColumnOwner="vwTASKS" ColumnName="ASSIGNED_TO" GroupBy="True" />
						</SelectedColumns>
					</QueryDefinition>
				</rd:DesignerState>
			</Query>
			...
			<Body>
				<ReportItems>
					<Tablix Name="Tablix1">
						...
						<DataSetName>vwTASKS</DataSetName>
						<Top>6.5in</Top>
						<Height>0.5in</Height>
						<Width>8.5in</Width>
						<Style>
					...
					<Chart Name="Chart1">
									...
									<ChartDataPoints>
										<ChartDataPoint>
											...
											<ActionInfo>
												<Actions>
													<Action>
														<Hyperlink>="~/Tasks/default.aspx?TEAM_NAME=" + Fields!TEAM_NAME.Value + "&amp;ASSIGNED_TO=" + Fields!ASSIGNED_TO.Value</Hyperlink>
													</Action>
												</Actions>
											</ActionInfo>
											<Style />
						...
						<ChartTitles>
							<ChartTitle Name="Default">
								<Caption>Tasks By Team By User</Caption>
								<Style>
									<BackgroundGradientType>None</BackgroundGradientType>
									<FontFamily>Tahoma</FontFamily>
	...
	<rd:ReportID>14b9fbce-25de-451c-8c18-4dc4600462e1</rd:ReportID>
...
call dbo.spREPORTS_Tasks_By_Team_By_User()
/

call dbo.spSqlDropProcedure('spREPORTS_Tasks_By_Team_By_User')
/
