...
print 'REPORTS Generic Quote';
GO

set nocount on;
GO

-- delete from REPORTS where ID = 'E0082268-2FFE-4C25-B700-83F3E5254167';
...
if exists(select * from REPORTS where ID = 'E0082268-2FFE-4C25-B700-83F3E5254167' and RDL not like '%AllowBlank%' and DELETED = 0) begin -- then
	update REPORTS
	   set RDL = replace(cast(RDL as nvarchar(max)), '<Prompt>QUOTE_ID</Prompt>', '<AllowBlank>true</AllowBlank>
			<Prompt>Quote ID</Prompt>')
	     , DATE_MODIFIED    = getdate()
	     , MODIFIED_USER_ID = null
	 where ID = 'E0082268-2FFE-4C25-B700-83F3E5254167'
...
-- delete from REPORTS where ID = 'E0082268-2FFE-4C25-B700-83F3E5254167';
exec dbo.spREPORTS_InsertOnly 'E0082268-2FFE-4C25-B700-83F3E5254167', 'Generic Quote', 'Quotes', 'Freeform', '<?xml version="1.0" encoding="utf-8"?>
<Report xmlns:rd="http://schemas.microsoft.com/SQLServer/reporting/reportdesigner" xmlns:cl="http://schemas.microsoft.com/sqlserver/reporting/2010/01/componentdefinition" xmlns="http://schemas.microsoft.com/sqlserver/reporting/2010/01/reportdefinition">
	...
	<DataSets>
		<DataSet Name="vwQUOTES_LINE_ITEMS">
			<Query>
				<DataSourceName>SplendidCRM</DataSourceName>
				<QueryParameters>
					<QueryParameter Name="@QUOTE_ID">
						<Value>=Parameters!QUOTE_ID.Value</Value>
					</QueryParameter>
				</QueryParameters>
				<CommandText>select * from vwQUOTES_LINE_ITEMS where QUOTE_ID = @QUOTE_ID order by POSITION</CommandText>
		...
		<DataSet Name="vwQUOTES">
			<Query>
				...
				<CommandText>select * from vwQUOTES where ID = @QUOTE_ID</CommandText>
				<rd:UseGenericDesigner>true</rd:UseGenericDesigner>
			</Query>
			<Fields>
				<Field Name="ID">
				...
				<Field Name="QUOTE_TYPE">
					<DataField>QUOTE_TYPE</DataField>
					<rd:TypeName>System.String</rd:TypeName>
				</Field>
				...
				<Field Name="QUOTE_STAGE">
					<DataField>QUOTE_STAGE</DataField>
					<rd:TypeName>System.String</rd:TypeName>
				</Field>
				...
				<Field Name="DATE_QUOTE_CLOSED">
					<DataField>DATE_QUOTE_CLOSED</DataField>
					<rd:TypeName>System.DateTime</rd:TypeName>
				</Field>
				<Field Name="DATE_QUOTE_EXPECTED_CLOSED">
					<DataField>DATE_QUOTE_EXPECTED_CLOSED</DataField>
					<rd:TypeName>System.DateTime</rd:TypeName>
				</Field>
				...
				<Field Name="OPPORTUNITY_ASSIGNED_USER_ID">
					<DataField>OPPORTUNITY_ASSIGNED_USER_ID</DataField>
					<rd:TypeName>System.Guid</rd:TypeName>
				</Field>
			...
			<Body>
				<ReportItems>
					<Tablix Name="tblLINE_ITEMS">
						...
						<DataSetName>vwQUOTES_LINE_ITEMS</DataSetName>
						<Top>2.625in</Top>
					...
					<Tablix Name="divADDRESS">
						...
						<DataSetName>vwQUOTES</DataSetName>
						<Top>1.375in</Top>
						<Height>1.125in</Height>
						<Width>3.25in</Width>
						<ZIndex>2</ZIndex>
														...
														<Textbox Name="ORDER_NUM">
															...
															<Paragraphs>
																<Paragraph>
																	<TextRuns>
																		<TextRun>
																			<Value>=Fields!QUOTE_NUM.Value</Value>
																			<Style />
																		</TextRun>
																	</TextRuns>
																	<Style>
	...
	<rd:ReportID>e0082268-2ffe-4c25-b700-83f3e5254167</rd:ReportID>
...
call dbo.spREPORTS_Generic_Quote()
/

call dbo.spSqlDropProcedure('spREPORTS_Generic_Quote')
/
