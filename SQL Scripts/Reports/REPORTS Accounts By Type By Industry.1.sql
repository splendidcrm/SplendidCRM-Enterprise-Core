...
print 'REPORTS Accounts By Type By Industry';
GO

set nocount on;
GO

-- delete from REPORTS where ID = 'A5786178-CCC8-4EA6-A556-F421E122493F';
exec dbo.spREPORTS_InsertOnly 'A5786178-CCC8-4EA6-A556-F421E122493F', 'Accounts By Type By Industry', 'Accounts', 'Freeform', '<?xml version="1.0" encoding="utf-8"?>
   ...
   and (TEAM_ID is null or vwTEAM_MEMBERSHIPS.MEMBERSHIP_TEAM_ID is not null)
				...
				<rd:DesignerState>
					<QueryDefinition xmlns="http://schemas.microsoft.com/ReportingServices/QueryDefinition/Relational">
						<SelectedColumns>
							<ColumnExpression ColumnOwner="vwACCOUNTS" ColumnName="ACCOUNT_TYPE" GroupBy="True" />
							<ColumnExpression ColumnOwner="vwACCOUNTS" ColumnName="INDUSTRY" GroupBy="True" />
						</SelectedColumns>
					</QueryDefinition>
				</rd:DesignerState>
			</Query>
							...
							<TablixMembers>
								...
								<TablixMember>
									<Group Name="ACCOUNT_TYPE">
										<GroupExpressions>
											<GroupExpression>=Fields!ACCOUNT_TYPE.Value</GroupExpression>
										</GroupExpressions>
									</Group>
									<SortExpressions>
										<SortExpression>
									...
									<TablixMembers>
										<TablixMember>
											<Group Name="INDUSTRY">
												<GroupExpressions>
													<GroupExpression>=Fields!INDUSTRY.Value</GroupExpression>
												</GroupExpressions>
											</Group>
											<SortExpressions>
												<SortExpression>
													<Value>=Fields!INDUSTRY.Value</Value>
												</SortExpression>
											</SortExpressions>
											<TablixHeader>
												<Size>2.83333in</Size>
												<CellContents>
													<Textbox Name="INDUSTRY">
														<CanGrow>true</CanGrow>
														<KeepTogether>true</KeepTogether>
														<Paragraphs>
															<Paragraph>
														...
														<rd:DefaultName>INDUSTRY</rd:DefaultName>
														<Style>
															<Border>
																<Color>#e6eefc</Color>
																<Style>Solid</Style>
					...
					<Chart Name="Chart1">
						<ChartCategoryHierarchy>
							<ChartMembers>
								<ChartMember>
									...
									<Label>=Fields!ACCOUNT_TYPE.Value</Label>
								</ChartMember>
							</ChartMembers>
						</ChartCategoryHierarchy>
						<ChartSeriesHierarchy>
							<ChartMembers>
								<ChartMember>
									...
									<Label>=Fields!INDUSTRY.Value</Label>
								</ChartMember>
							</ChartMembers>
						</ChartSeriesHierarchy>
						<ChartData>
									...
									<ChartDataPoints>
										<ChartDataPoint>
											...
											<ActionInfo>
												<Actions>
													<Action>
														<Hyperlink>="~/Accounts/default.aspx?ACCOUNT_TYPE=" + Fields!ACCOUNT_TYPE.Value + "&amp;INDUSTRY=" + Fields!INDUSTRY.Value</Hyperlink>
													</Action>
												</Actions>
											</ActionInfo>
											<Style />
						...
						<ChartTitles>
							<ChartTitle Name="Default">
								<Caption>Accounts By Type By Industry</Caption>
								<Style>
									<BackgroundGradientType>None</BackgroundGradientType>
									<FontFamily>Tahoma</FontFamily>
	...
	<rd:ReportID>A5786178-CCC8-4EA6-A556-F421E122493F</rd:ReportID>
...
call dbo.spREPORTS_Accounts_By_Type_By_Industry()
/

call dbo.spSqlDropProcedure('spREPORTS_Accounts_By_Type_By_Industry')
/
