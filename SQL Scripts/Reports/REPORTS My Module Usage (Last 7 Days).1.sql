...
print 'REPORTS My Module Usage (Last 7 Days)';
GO

set nocount on;
GO

-- delete from REPORTS where ID = '86D50433-23C2-49CB-A3C2-247D3618966E';
exec dbo.spREPORTS_InsertOnly '86D50433-23C2-49CB-A3C2-247D3618966E', 'My Module Usage (Last 7 Days)', 'Trackers', 'Freeform', '<?xml version="1.0" encoding="utf-8"?>
	...
	<DataSets>
		<DataSet Name="vwTRACKER">
			<Query>
				...
				<CommandText>select ITEM_ID
        , MODULE_NAME
  from vwTRACKER
 where DATE_MODIFIED &gt; dbo.fnDateAdd(''day'', -7, getdate())
   and USER_ID = @ASSIGNED_USER_ID</CommandText>
					...
					<Chart Name="Chart1">
						...
						<ChartTitles>
							<ChartTitle Name="Default">
								<Caption>My Module Usage (Last 7 Days)</Caption>
								<Style>
									<BackgroundGradientType>None</BackgroundGradientType>
									<FontFamily>Tahoma</FontFamily>
	...
	<rd:ReportID>86D50433-23C2-49CB-A3C2-247D3618966E</rd:ReportID>
...
call dbo.spREPORTS_My_Module_Usage_7Days()
/

call dbo.spSqlDropProcedure('spREPORTS_My_Module_Usage_7Days')
/
