...
print 'REPORTS My Module Usage (Today)';
GO

set nocount on;
GO

-- delete from REPORTS where ID = '2CB12AA7-E4B5-454A-B14C-6B11BC2E77D9';
exec dbo.spREPORTS_InsertOnly '2CB12AA7-E4B5-454A-B14C-6B11BC2E77D9', 'My Module Usage (Today)', 'Trackers', 'Freeform', '<?xml version="1.0" encoding="utf-8"?>
<Report xmlns:rd="http://schemas.microsoft.com/SQLServer/reporting/reportdesigner" xmlns:cl="http://schemas.microsoft.com/sqlserver/reporting/2010/01/componentdefinition" xmlns="http://schemas.microsoft.com/sqlserver/reporting/2010/01/reportdefinition">
	...
	<DataSets>
        ...
        , MODULE_NAME
  from vwTRACKER
 where DATE_MODIFIED &gt; dbo.fnDateOnly(getdate())
   and USER_ID = @ASSIGNED_USER_ID</CommandText>
					...
					<Chart Name="Chart1">
						...
						<ChartTitles>
							<ChartTitle Name="Default">
								<Caption>My Module Usage (Today)</Caption>
								<Style>
									<BackgroundGradientType>None</BackgroundGradientType>
									<FontFamily>Tahoma</FontFamily>
	...
	<rd:ReportID>2CB12AA7-E4B5-454A-B14C-6B11BC2E77D9</rd:ReportID>
...
call dbo.spREPORTS_My_Module_Usage_Today()
/

call dbo.spSqlDropProcedure('spREPORTS_My_Module_Usage_Today')
/
