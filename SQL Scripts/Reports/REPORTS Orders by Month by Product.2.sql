...
print 'REPORTS Orders by Month by Product';
GO
...
-- delete from REPORTS where ID = '85A94A36-8CEE-4844-A549-AE20BB9F0E86';
exec dbo.spREPORTS_InsertOnly '85A94A36-8CEE-4844-A549-AE20BB9F0E86', 'Orders by Month by Product', 'Orders', 'Freeform', '<?xml version="1.0" encoding="utf-8"?>
...
--     , vwORDERS_LINE_ITEMS.EXTENDED_PRICE
 ...
 order by dbo.fnMonthOnly(vwORDERS.DATE_ORDER_DUE) desc, vwORDERS_LINE_ITEMS.NAME
			...
			<Textbox Name="ReportTitle">
				...
				<Paragraphs>
					<Paragraph>
						<TextRuns>
							<TextRun>
								<Value>Orders by Month by Product</Value>
								<Style>
	...
	<rd:ReportID>85A94A36-8CEE-4844-A549-AE20BB9F0E86</rd:ReportID>
...
call dbo.spREPORTS_Orders_by_Month_by_Product()
/

call dbo.spSqlDropProcedure('spREPORTS_Orders_by_Month_by_Product')
/
