...
print 'REPORTS New Leads By Month';
GO

set nocount on;
GO

-- delete from REPORTS where ID = '85F26F43-F35D-44D2-9684-620D3342E863';
exec dbo.spREPORTS_InsertOnly '85F26F43-F35D-44D2-9684-620D3342E863', 'New Leads By Month', 'Leads', 'Freeform', '<?xml version="1.0" encoding="utf-8"?>
<Report xmlns:rd="http://schemas.microsoft.com/SQLServer/reporting/reportdesigner" xmlns:cl="http://schemas.microsoft.com/sqlserver/reporting/2010/01/componentdefinition" xmlns="http://schemas.microsoft.com/sqlserver/reporting/2010/01/reportdefinition">
 ...
 where 1 = 1
   and (TEAM_ID is null or vwTEAM_MEMBERSHIPS.MEMBERSHIP_TEAM_ID is not null)
					...
					<Chart Name="Chart1">
						...
						<ChartTitles>
							<ChartTitle Name="Default">
								<Caption>New Leads By Month</Caption>
								<Style>
									<BackgroundGradientType>None</BackgroundGradientType>
									<FontFamily>Tahoma</FontFamily>
	...
	<rd:ReportID>85F26F43-F35D-44D2-9684-620D3342E863</rd:ReportID>
...
call dbo.spREPORTS_New_Leads_By_Month()
/

call dbo.spSqlDropProcedure('spREPORTS_New_Leads_By_Month')
/
