...
print 'REPORTS Opportunities By Type';
GO

set nocount on;
GO

-- delete from REPORTS where ID = '1992F7B8-2D2C-48ED-A700-19AFF2A05712';
exec dbo.spREPORTS_InsertOnly '1992F7B8-2D2C-48ED-A700-19AFF2A05712', 'Opportunities By Type', 'Opportunities', 'Freeform', '<?xml version="1.0" encoding="utf-8"?>
<Report xmlns:rd="http://schemas.microsoft.com/SQLServer/reporting/reportdesigner" xmlns:cl="http://schemas.microsoft.com/sqlserver/reporting/2010/01/componentdefinition" xmlns="http://schemas.microsoft.com/sqlserver/reporting/2010/01/reportdefinition">
 ...
 order by DATE_CLOSED asc</CommandText>
			...
			<Body>
				<ReportItems>
					<Tablix Name="table1">
							...
							<TablixRows>
								<TablixRow>
									...
									<TablixCells>
										<TablixCell>
											<CellContents>
												<Textbox Name="OPPORTUNITY_TYPE1">
													...
													<Paragraphs>
														<Paragraph>
															<TextRuns>
																<TextRun>
																	<Value>="Type = " + Fields!OPPORTUNITY_TYPE.Value + ", Count = " + Str(Count(Fields!ID.Value))</Value>
																	<Style>
													...
													<rd:DefaultName>OPPORTUNITY_TYPE1</rd:DefaultName>
													<Style>
														<Border>
															<Style>None</Style>
														</Border>
										...
										<TablixCell>
											<CellContents>
												<Textbox Name="SALES_STAGE2">
													...
													<rd:DefaultName>SALES_STAGE2</rd:DefaultName>
													<Style>
														<Border>
															<Style>None</Style>
														</Border>
						...
						<Height>0.84541in</Height>
						<Width>8.49167in</Width>
						<Style />
					</Tablix>
				</ReportItems>
				<Height>11in</Height>
	...
	<rd:ReportID>1992F7B8-2D2C-48ED-A700-19AFF2A05712</rd:ReportID>
...
call dbo.spREPORTS_Opportunities_By_Type()
/

call dbo.spSqlDropProcedure('spREPORTS_Opportunities_By_Type')
/
