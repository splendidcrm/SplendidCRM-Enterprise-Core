...
print 'REPORTS My Recently Modified Records (Last 30 Days)';
GO

set nocount on;
GO

-- delete from REPORTS where ID = '64D49611-221D-41B5-9010-4A040CA840BC';
exec dbo.spREPORTS_InsertOnly '64D49611-221D-41B5-9010-4A040CA840BC', 'My Recently Modified Records (Last 30 Days)', 'Trackers', 'Freeform', '<?xml version="1.0" encoding="utf-8"?>
<Report xmlns:rd="http://schemas.microsoft.com/SQLServer/reporting/reportdesigner" xmlns:cl="http://schemas.microsoft.com/sqlserver/reporting/2010/01/componentdefinition" xmlns="http://schemas.microsoft.com/sqlserver/reporting/2010/01/reportdefinition">
  ...
  from vwTRACKER
 where ACTION        = ''Save''
   and DATE_MODIFIED &gt; dbo.fnDateAdd(''day'', -30, getdate())
   and USER_ID = @ASSIGNED_USER_ID</CommandText>
	...
	<ReportParameters>
		<ReportParameter Name="ASSIGNED_USER_ID">
			...
			<Prompt>Assigned User ID:</Prompt>
		</ReportParameter>
	</ReportParameters>
	<ConsumeContainerWhitespace>true</ConsumeContainerWhitespace>
	<rd:ReportUnitType>Inch</rd:ReportUnitType>
	<rd:ReportID>64D49611-221D-41B5-9010-4A040CA840BC</rd:ReportID>
...
call dbo.spREPORTS_My_Recently_Modified_30Days()
/

call dbo.spSqlDropProcedure('spREPORTS_My_Recently_Modified_30Days')
/
