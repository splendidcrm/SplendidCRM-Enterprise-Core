...
print 'REPORTS Current Quarter Forecast';
GO

set nocount on;
GO

-- delete from REPORTS where ID = '330E4D42-CBCA-42B9-9F2E-569B9C677632';
exec dbo.spREPORTS_InsertOnly '330E4D42-CBCA-42B9-9F2E-569B9C677632', 'Current Quarter Forecast', 'Opportunities', 'Freeform', '<?xml version="1.0" encoding="utf-8"?>
<Report xmlns:rd="http://schemas.microsoft.com/SQLServer/reporting/reportdesigner" xmlns:cl="http://schemas.microsoft.com/sqlserver/reporting/2010/01/componentdefinition" xmlns="http://schemas.microsoft.com/sqlserver/reporting/2010/01/reportdefinition">
 ...
 where DATE_CLOSED between dbo.fnDateSpecial(''this quarter'') and dbo.fnDateSpecial(''next quarter'')
 ...
 order by NAME asc</CommandText>
	...
	<rd:ReportID>330E4D42-CBCA-42B9-9F2E-569B9C677632</rd:ReportID>
...
call dbo.spREPORTS_Current_Quarter_Forecast()
/

call dbo.spSqlDropProcedure('spREPORTS_Current_Quarter_Forecast')
/
