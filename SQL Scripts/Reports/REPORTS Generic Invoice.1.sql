...
print 'REPORTS Generic Invoice';
GO

set nocount on;
GO

-- delete from REPORTS where ID = 'BEA2A797-8A1D-47D8-A03E-B9841F494272';
...
if exists(select * from REPORTS where ID = 'BEA2A797-8A1D-47D8-A03E-B9841F494272' and RDL not like '%AllowBlank%' and DELETED = 0) begin -- then
	update REPORTS
	 ...
	 where ID = 'BEA2A797-8A1D-47D8-A03E-B9841F494272'
...
-- delete from REPORTS where ID = 'BEA2A797-8A1D-47D8-A03E-B9841F494272';
exec dbo.spREPORTS_InsertOnly 'BEA2A797-8A1D-47D8-A03E-B9841F494272', 'Generic Invoice', 'Invoices', 'Freeform', '<?xml version="1.0" encoding="utf-8"?>
<Report xmlns:rd="http://schemas.microsoft.com/SQLServer/reporting/reportdesigner" xmlns:cl="http://schemas.microsoft.com/sqlserver/reporting/2010/01/componentdefinition" xmlns="http://schemas.microsoft.com/sqlserver/reporting/2010/01/reportdefinition">
	...
	<DataSets>
		<DataSet Name="vwINVOICES_LINE_ITEMS">
			<Query>
				<DataSourceName>SplendidCRM</DataSourceName>
				<QueryParameters>
					<QueryParameter Name="@INVOICE_ID">
						<Value>=Parameters!INVOICE_ID.Value</Value>
					</QueryParameter>
				</QueryParameters>
				<CommandText>select * from vwINVOICES_LINE_ITEMS where INVOICE_ID = @INVOICE_ID order by POSITION</CommandText>
		...
		<DataSet Name="vwINVOICES">
			<Query>
				...
				<CommandText>select * from vwINVOICES where ID = @INVOICE_ID</CommandText>
				<rd:UseGenericDesigner>true</rd:UseGenericDesigner>
			</Query>
			<Fields>
				<Field Name="ID">
				...
				<Field Name="INVOICE_STAGE">
					<DataField>INVOICE_STAGE</DataField>
					<rd:TypeName>System.String</rd:TypeName>
				</Field>
				...
				<Field Name="ORDER_NAME">
					<DataField>ORDER_NAME</DataField>
					<rd:TypeName>System.String</rd:TypeName>
				</Field>
			...
			<Body>
				<ReportItems>
					<Tablix Name="tblLINE_ITEMS">
						...
						<DataSetName>vwINVOICES_LINE_ITEMS</DataSetName>
						<Top>2.625in</Top>
					...
					<Tablix Name="divADDRESS">
						...
						<DataSetName>vwINVOICES</DataSetName>
						<Top>1.375in</Top>
						<Height>1.125in</Height>
						<Width>3.25in</Width>
						<ZIndex>2</ZIndex>
	...
	<ReportParameters>
		<ReportParameter Name="INVOICE_ID">
	...
	<rd:ReportID>bea2a797-8a1d-47d8-a03e-b9841f494272</rd:ReportID>
...
call dbo.spREPORTS_Generic_Invoice()
/

call dbo.spSqlDropProcedure('spREPORTS_Generic_Invoice')
/
