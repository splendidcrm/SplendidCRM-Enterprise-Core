...
print 'REPORTS Meetings By Team By User';
GO

set nocount on;
GO

-- delete from REPORTS where ID = '219B261B-4EC6-4DF4-BCBD-CEC7C7F98B9F';
exec dbo.spREPORTS_InsertOnly '219B261B-4EC6-4DF4-BCBD-CEC7C7F98B9F', 'Meetings By Team By User', 'Meetings', 'Freeform', '<?xml version="1.0" encoding="utf-8"?>
   ...
   and (TEAM_ID is null or vwTEAM_MEMBERSHIPS.MEMBERSHIP_TEAM_ID is not null)
				...
				<rd:DesignerState>
					<QueryDefinition xmlns="http://schemas.microsoft.com/ReportingServices/QueryDefinition/Relational">
						<SelectedColumns>
							<ColumnExpression ColumnOwner="vwMEETINGS" ColumnName="TEAM_NAME" GroupBy="True" />
							<ColumnExpression ColumnOwner="vwMEETINGS" ColumnName="ASSIGNED_TO" GroupBy="True" />
						</SelectedColumns>
					</QueryDefinition>
				</rd:DesignerState>
			</Query>
					...
					<Chart Name="Chart1">
									...
									<ChartDataPoints>
										<ChartDataPoint>
											...
											<ActionInfo>
												<Actions>
													<Action>
														<Hyperlink>="~/Meetings/default.aspx?TEAM_NAME=" + Fields!TEAM_NAME.Value + "&amp;ASSIGNED_TO=" + Fields!ASSIGNED_TO.Value</Hyperlink>
													</Action>
												</Actions>
											</ActionInfo>
											<Style />
						...
						<ChartTitles>
							<ChartTitle Name="Default">
								<Caption>Meetings By Team By User</Caption>
								<Style>
									<BackgroundGradientType>None</BackgroundGradientType>
									<FontFamily>Tahoma</FontFamily>
	...
	<rd:ReportID>219B261B-4EC6-4DF4-BCBD-CEC7C7F98B9F</rd:ReportID>
...
call dbo.spREPORTS_Meetings_By_Team_By_User()
/

call dbo.spSqlDropProcedure('spREPORTS_Meetings_By_Team_By_User')
/
