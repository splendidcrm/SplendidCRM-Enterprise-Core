...
print 'REPORTS Detailed Forecast';
GO

set nocount on;
GO

-- delete from REPORTS where ID = '43A4CDBD-8536-4E1C-BC65-8228F0612748';
exec dbo.spREPORTS_InsertOnly '43A4CDBD-8536-4E1C-BC65-8228F0612748', 'Detailed Forecast', 'Opportunities', 'Freeform', '<?xml version="1.0" encoding="utf-8"?>
<Report xmlns:rd="http://schemas.microsoft.com/SQLServer/reporting/reportdesigner" xmlns:cl="http://schemas.microsoft.com/sqlserver/reporting/2010/01/componentdefinition" xmlns="http://schemas.microsoft.com/sqlserver/reporting/2010/01/reportdefinition">
 ...
 order by PROBABILITY asc
												...
												<Textbox Name="NEXT_STEP">
													...
													<Paragraphs>
														<Paragraph>
															<TextRuns>
																<TextRun>
																	<Value>=Fields!NEXT_STEP.Value</Value>
																	<Style />
																</TextRun>
															</TextRuns>
															<Style>
													...
													<rd:DefaultName>NEXT_STEP</rd:DefaultName>
													<Style>
														<Border>
															<Style>None</Style>
														</Border>
	...
	<rd:ReportID>43a4cdbd-8536-4e1c-bc65-8228f0612748</rd:ReportID>
...
call dbo.spREPORTS_Detailed_Forecast()
/

call dbo.spSqlDropProcedure('spREPORTS_Detailed_Forecast')
/
