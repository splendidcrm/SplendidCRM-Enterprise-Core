...
-- delete from REPORTS where ID = '8BCC3F8B-5EA0-4FD2-91FA-E564B9F81DB1';
exec dbo.spREPORTS_InsertOnly '8BCC3F8B-5EA0-4FD2-91FA-E564B9F81DB1', 'My Module Usage (Last 30 Days)', 'Trackers', 'Freeform', '<?xml version="1.0" encoding="utf-8"?>
<Report xmlns:rd="http://schemas.microsoft.com/SQLServer/reporting/reportdesigner" xmlns:cl="http://schemas.microsoft.com/sqlserver/reporting/2010/01/componentdefinition" xmlns="http://schemas.microsoft.com/sqlserver/reporting/2010/01/reportdefinition">
	...
	<DataSets>
        ...
        , MODULE_NAME
  from vwTRACKER
 where DATE_MODIFIED &gt; dbo.fnDateAdd(''day'', -30, getdate())
   and USER_ID = @ASSIGNED_USER_ID</CommandText>
					...
					<Chart Name="Chart1">
						...
						<ChartTitles>
							<ChartTitle Name="Default">
								<Caption>My Module Usage (Last 30 Days)</Caption>
								<Style>
									<BackgroundGradientType>None</BackgroundGradientType>
									<FontFamily>Tahoma</FontFamily>
	...
	<rd:ReportID>8BCC3F8B-5EA0-4FD2-91FA-E564B9F81DB1</rd:ReportID>
