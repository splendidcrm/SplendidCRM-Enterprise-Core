...
print 'REPORTS Pipeline By Type By Team';
GO

set nocount on;
GO

-- delete from REPORTS where ID = '0EF4C440-ABE3-4A8A-AAEB-9F2C9292371E';
exec dbo.spREPORTS_InsertOnly '0EF4C440-ABE3-4A8A-AAEB-9F2C9292371E', 'Pipeline By Type By Team', 'Opportunities', 'Freeform', '<?xml version="1.0" encoding="utf-8"?>
<Report xmlns:rd="http://schemas.microsoft.com/SQLServer/reporting/reportdesigner" xmlns:cl="http://schemas.microsoft.com/sqlserver/reporting/2010/01/componentdefinition" xmlns="http://schemas.microsoft.com/sqlserver/reporting/2010/01/reportdefinition">
 ...
 where SALES_STAGE in (''Prospecting'', ''Qualification'', ''Needs Analysis'', ''Value Proposition'', ''Id. Decision Makers'', ''Perception Analysis'', ''Proposal/Price Quote'', ''Negotiation/Review'')
   and (TEAM_ID is null or vwTEAM_MEMBERSHIPS.MEMBERSHIP_TEAM_ID is not null)
</CommandText>
				<rd:DesignerState>
					<QueryDefinition xmlns="http://schemas.microsoft.com/ReportingServices/QueryDefinition/Relational">
						<SelectedColumns>
							<ColumnExpression ColumnOwner="vwOPPORTUNITIES" ColumnName="TEAM_NAME" GroupBy="True" />
							<ColumnExpression ColumnOwner="vwOPPORTUNITIES" ColumnName="OPPORTUNITY_TYPE" GroupBy="True" />
						</SelectedColumns>
					</QueryDefinition>
				</rd:DesignerState>
			</Query>
					...
					<Tablix Name="Tablix1">
						...
						<TablixRowHierarchy>
							<TablixMembers>
								...
								<TablixMember>
									<Group Name="OPPORTUNITY_TYPE">
										<GroupExpressions>
											<GroupExpression>=Fields!OPPORTUNITY_TYPE.Value</GroupExpression>
										</GroupExpressions>
									</Group>
									<SortExpressions>
										<SortExpression>
					...
					<Chart Name="Chart1">
						...
						<ChartSeriesHierarchy>
							<ChartMembers>
								<ChartMember>
									...
									<Label>=Fields!OPPORTUNITY_TYPE.Value</Label>
								</ChartMember>
							</ChartMembers>
						</ChartSeriesHierarchy>
						<ChartData>
									...
									<ChartDataPoints>
										<ChartDataPoint>
											...
											<ActionInfo>
												<Actions>
													<Action>
														<Hyperlink>="~/Opportunities/default.aspx?OPPORTUNITY_TYPE=" + Fields!OPPORTUNITY_TYPE.Value + "&amp;TEAM_NAME=" + Fields!TEAM_NAME.Value</Hyperlink>
													</Action>
												</Actions>
											</ActionInfo>
											<Style />
						...
						<ChartTitles>
							<ChartTitle Name="Default">
								<Caption>Pipeline By Type By Team</Caption>
								<Style>
									<BackgroundGradientType>None</BackgroundGradientType>
									<FontFamily>Tahoma</FontFamily>
	...
	<rd:ReportID>0ef4c440-abe3-4a8a-aaeb-9f2c9292371e</rd:ReportID>
...
call dbo.spREPORTS_Pipeline_By_Type_By_Team()
/

call dbo.spSqlDropProcedure('spREPORTS_Pipeline_By_Type_By_Team')
/
