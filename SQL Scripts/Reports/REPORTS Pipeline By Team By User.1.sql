...
print 'REPORTS Pipeline By Team By User';
GO

set nocount on;
GO

-- delete from REPORTS where ID = 'CC7814B8-3AB2-49F5-9353-E42493955466';
exec dbo.spREPORTS_InsertOnly 'CC7814B8-3AB2-49F5-9353-E42493955466', 'Pipeline By Team By User', 'Opportunities', 'Freeform', '<?xml version="1.0" encoding="utf-8"?>
<Report xmlns:rd="http://schemas.microsoft.com/SQLServer/reporting/reportdesigner" xmlns:cl="http://schemas.microsoft.com/sqlserver/reporting/2010/01/componentdefinition" xmlns="http://schemas.microsoft.com/sqlserver/reporting/2010/01/reportdefinition">
 ...
 where SALES_STAGE in (''Prospecting'', ''Qualification'', ''Needs Analysis'', ''Value Proposition'', ''Id. Decision Makers'', ''Perception Analysis'', ''Proposal/Price Quote'', ''Negotiation/Review'')
   and (TEAM_ID is null or vwTEAM_MEMBERSHIPS.MEMBERSHIP_TEAM_ID is not null)
				...
				<rd:DesignerState>
					<QueryDefinition xmlns="http://schemas.microsoft.com/ReportingServices/QueryDefinition/Relational">
						<SelectedColumns>
							...
							<ColumnExpression ColumnOwner="vwOPPORTUNITIES" ColumnName="ASSIGNED_TO" GroupBy="True" />
						</SelectedColumns>
					</QueryDefinition>
				</rd:DesignerState>
			</Query>
					...
					<Chart Name="Chart1">
									...
									<ChartDataPoints>
										<ChartDataPoint>
											...
											<ActionInfo>
												<Actions>
													<Action>
														<Hyperlink>="~/Opportunities/default.aspx?TEAM_NAME=" + Fields!TEAM_NAME.Value + "&amp;ASSIGNED_TO=" + Fields!ASSIGNED_TO.Value</Hyperlink>
													</Action>
												</Actions>
											</ActionInfo>
											<Style />
						...
						<ChartTitles>
							<ChartTitle Name="Default">
								<Caption>Pipeline By Team By User</Caption>
								<Style>
									<BackgroundGradientType>None</BackgroundGradientType>
									<FontFamily>Tahoma</FontFamily>
	...
	<rd:ReportID>cc7814b8-3ab2-49f5-9353-e42493955466</rd:ReportID>
...
call dbo.spREPORTS_Pipeline_By_Team_By_User()
/

call dbo.spSqlDropProcedure('spREPORTS_Pipeline_By_Team_By_User')
/
