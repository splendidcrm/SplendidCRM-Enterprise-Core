if exists (select * from INFORMATION_SCHEMA.VIEWS where TABLE_NAME = 'vwCAMPAIGNS_InvalidPhones')
	Drop View dbo.vwCAMPAIGNS_InvalidPhones;
GO
...
Create View dbo.vwCAMPAIGNS_InvalidPhones
as
select distinct
       CALL_MARKETING.CAMPAIGN_ID                   as CAMPAIGN_ID
     , CALL_MARKETING.ID                            as CALL_MARKETING_ID
     , vwPROSPECT_LISTS_InvalidPhones.ID            as PROSPECT_LIST_ID
     , vwPROSPECT_LISTS_InvalidPhones.RELATED_ID    as RELATED_ID
     , vwPROSPECT_LISTS_InvalidPhones.RELATED_TYPE  as RELATED_TYPE
     , vwPROSPECT_LISTS_InvalidPhones.RELATED_NAME  as RELATED_NAME
     , vwPROSPECT_LISTS_InvalidPhones.PHONE_WORK    as PHONE_WORK
  ...
  from            CALL_MARKETING
       ...
       inner join vwPROSPECT_LISTS_InvalidPhones
               on vwPROSPECT_LISTS_InvalidPhones.ID                     = PROSPECT_LIST_CAMPAIGNS.PROSPECT_LIST_ID
       inner join vwCAMPAIGNS_PROSPECT_LIST_Call
               on vwCAMPAIGNS_PROSPECT_LIST_Call.PROSPECT_LIST_ID       = vwPROSPECT_LISTS_InvalidPhones.ID
...
Grant Select on dbo.vwCAMPAIGNS_InvalidPhones to public;
GO
