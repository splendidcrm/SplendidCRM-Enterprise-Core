if exists (select * from INFORMATION_SCHEMA.VIEWS where TABLE_NAME = 'vwCONTACTS_QUOTES')
	Drop View dbo.vwCONTACTS_QUOTES;
GO
...
Create View dbo.vwCONTACTS_QUOTES
as
...
Grant Select on dbo.vwCONTACTS_QUOTES to public;
GO
