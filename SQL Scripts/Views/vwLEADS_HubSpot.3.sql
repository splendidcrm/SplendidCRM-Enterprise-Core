if exists (select * from INFORMATION_SCHEMA.VIEWS where TABLE_NAME = 'vwLEADS_HubSpot')
	Drop View dbo.vwLEADS_HubSpot;
GO
...
Create View dbo.vwLEADS_HubSpot
as
select *
  from vwLEADS
...
Grant Select on dbo.vwLEADS_HubSpot to public;
GO
