if exists (select * from INFORMATION_SCHEMA.VIEWS where TABLE_NAME = 'vwCONTACTS_PROSPECT_LISTS')
	Drop View dbo.vwCONTACTS_PROSPECT_LISTS;
GO
...
Create View dbo.vwCONTACTS_PROSPECT_LISTS
as
select CONTACTS.ID                  as CONTACT_ID
  ...
  from            CONTACTS
       inner join PROSPECT_LISTS_PROSPECTS
               on PROSPECT_LISTS_PROSPECTS.RELATED_ID   = CONTACTS.ID
...
Grant Select on dbo.vwCONTACTS_PROSPECT_LISTS to public;
GO
