if exists (select * from INFORMATION_SCHEMA.VIEWS where TABLE_NAME = 'vwQUOTES_CONTACTS')
	Drop View dbo.vwQUOTES_CONTACTS;
GO
...
Create View dbo.vwQUOTES_CONTACTS
as
