if exists (select * from INFORMATION_SCHEMA.VIEWS where TABLE_NAME = 'vwFORUMS_THREADS')
	Drop View dbo.vwFORUMS_THREADS;
GO
 ...
 * 
 *********************************************************************************************************************/
Create View dbo.vwFORUMS_THREADS
as
select vwTHREADS.ID                   as THREAD_ID
...
Grant Select on dbo.vwFORUMS_THREADS to public;
GO
