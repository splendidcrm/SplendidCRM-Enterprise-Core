if exists (select * from INFORMATION_SCHEMA.VIEWS where TABLE_NAME = 'vwREVENUE_Pipeline')
	Drop View dbo.vwREVENUE_Pipeline;
GO
 ...
 * 
 *********************************************************************************************************************/
Create View dbo.vwREVENUE_Pipeline
as
select OPPORTUNITIES.ID
  ...
  left outer join TERMINOLOGY
               on TERMINOLOGY.NAME                  = REVENUE_LINE_ITEMS.SALES_STAGE
...
Grant Select on dbo.vwREVENUE_Pipeline to public;
GO
