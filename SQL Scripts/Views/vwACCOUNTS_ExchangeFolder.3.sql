if exists (select * from INFORMATION_SCHEMA.VIEWS where TABLE_NAME = 'vwACCOUNTS_ExchangeFolder')
	Drop View dbo.vwACCOUNTS_ExchangeFolder;
GO
...
Create View dbo.vwACCOUNTS_ExchangeFolder
as
...
Grant Select on dbo.vwACCOUNTS_ExchangeFolder to public;
GO
