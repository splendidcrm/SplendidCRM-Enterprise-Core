if exists (select * from INFORMATION_SCHEMA.VIEWS where TABLE_NAME = 'vwMEETINGS_USERS_Soap')
	Drop View dbo.vwMEETINGS_USERS_Soap;
GO
...
Create View dbo.vwMEETINGS_USERS_Soap
as
select MEETINGS_USERS.MEETING_ID as PRIMARY_ID
     , MEETINGS_USERS.USER_ID    as RELATED_ID
...
Grant Select on dbo.vwMEETINGS_USERS_Soap to public;
GO
