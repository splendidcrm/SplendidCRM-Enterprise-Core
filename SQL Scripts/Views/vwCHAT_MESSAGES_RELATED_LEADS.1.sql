if exists (select * from INFORMATION_SCHEMA.VIEWS where TABLE_NAME = 'vwCHAT_MESSAGES_RELATED_LEADS')
	Drop View dbo.vwCHAT_MESSAGES_RELATED_LEADS;
GO
 ...
 * 
 *********************************************************************************************************************/
Create View dbo.vwCHAT_MESSAGES_RELATED_LEADS
as
select ID
...
select CHAT_MESSAGES.ID
     , CHAT_CHANNELS.PARENT_ID as LEAD_ID
  from      CHAT_CHANNELS
...
Grant Select on dbo.vwCHAT_MESSAGES_RELATED_LEADS to public;
GO
