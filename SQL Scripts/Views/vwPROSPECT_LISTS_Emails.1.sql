if exists (select * from INFORMATION_SCHEMA.VIEWS where TABLE_NAME = 'vwPROSPECT_LISTS_Emails')
	Drop View dbo.vwPROSPECT_LISTS_Emails;
GO
...
Create View dbo.vwPROSPECT_LISTS_Emails
as
...
select PROSPECT_LISTS.ID                                         as ID
 ...
 where PROSPECT_LISTS.DELETED = 0
   and PROSPECTS.EMAIL1 is not null
...
Grant Select on dbo.vwPROSPECT_LISTS_Emails to public;
GO
