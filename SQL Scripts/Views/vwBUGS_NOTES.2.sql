if exists (select * from INFORMATION_SCHEMA.VIEWS where TABLE_NAME = 'vwBUGS_NOTES')
	Drop View dbo.vwBUGS_NOTES;
GO
...
Create View dbo.vwBUGS_NOTES
as
select NOTES.ID                       as ACTIVITY_ID
     , N'Notes'                       as ACTIVITY_TYPE
     , NOTES.NAME                     as ACTIVITY_NAME
     , BUGS.ASSIGNED_USER_ID          as ACTIVITY_ASSIGNED_USER_ID
     , BUGS.ASSIGNED_SET_ID           as ACTIVITY_ASSIGNED_SET_ID
     , N'Note'                        as STATUS
     , N'none'                        as DIRECTION
...
Grant Select on dbo.vwBUGS_NOTES to public;
GO
