if exists (select * from INFORMATION_SCHEMA.VIEWS where TABLE_NAME = 'vwCONTACTS_Marketo')
	Drop View dbo.vwCONTACTS_Marketo;
GO
...
Create View dbo.vwCONTACTS_Marketo
as
select *
  from vwCONTACTS
...
Grant Select on dbo.vwCONTACTS_Marketo to public;
GO
