if exists (select * from INFORMATION_SCHEMA.VIEWS where TABLE_NAME = 'vwCAMPAIGNS_InvalidEmails')
	Drop View dbo.vwCAMPAIGNS_InvalidEmails;
GO
...
Create View dbo.vwCAMPAIGNS_InvalidEmails
as
select distinct
     ...
     , vwPROSPECT_LISTS_InvalidEmails.ID            as PROSPECT_LIST_ID
     , vwPROSPECT_LISTS_InvalidEmails.RELATED_ID    as RELATED_ID
     , vwPROSPECT_LISTS_InvalidEmails.RELATED_TYPE  as RELATED_TYPE
     , vwPROSPECT_LISTS_InvalidEmails.RELATED_NAME  as RELATED_NAME
     , vwPROSPECT_LISTS_InvalidEmails.EMAIL1        as EMAIL1
  ...
  from            EMAIL_MARKETING
       ...
       inner join vwPROSPECT_LISTS_InvalidEmails
               on vwPROSPECT_LISTS_InvalidEmails.ID                     = PROSPECT_LIST_CAMPAIGNS.PROSPECT_LIST_ID
       inner join vwCAMPAIGNS_PROSPECT_LIST_Send
               on vwCAMPAIGNS_PROSPECT_LIST_Send.PROSPECT_LIST_ID       = vwPROSPECT_LISTS_InvalidEmails.ID
...
Grant Select on dbo.vwCAMPAIGNS_InvalidEmails to public;
GO
