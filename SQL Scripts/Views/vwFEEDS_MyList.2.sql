if exists (select * from INFORMATION_SCHEMA.VIEWS where TABLE_NAME = 'vwFEEDS_MyList')
	Drop View dbo.vwFEEDS_MyList;
GO
...
Create View dbo.vwFEEDS_MyList
as
select vwFEEDS.*
...
Grant Select on dbo.vwFEEDS_MyList to public;
GO
